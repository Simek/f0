...
import { ey as IL, ex as AL, ew as TL, eD as DL, eE as EL, eA as _L, ez as LL, eC as OL, ba as RL, eB as FL } from "./F0AiChat-BjijoHX-.js";
...
function Rv(t, e, n, r) {
  if (typeof t == "function")
    return Lv(t);
  const i = typeof e == "function" ? e : Ov(e, n, r);
...
function zv({ children: t, as: e = "ul", axis: n = "y", onReorder: r, values: i, ...o }, s) {
  ...
  const f = {
    ...
    registerItem: (u, h) => {
      ...
      m !== -1 ? c[m].layout = h[n] : c.push({ value: u, layout: h[n] }), c.sort(jv);
    },
    updateOrder: (u, h, m) => {
      if (d.current)
        return;
      const p = Pv(c, u, h, m);
      c !== p && (d.current = !0, r(p.map($v).filter((b) => i.indexOf(b) !== -1)));
    }
  };
  return V(() => {
    d.current = !1;
...
function Bv({ children: t, style: e = {}, value: n, as: r = "li", onDrag: i, layout: o = !0, ...s }, a) {
  const c = qi(() => G[r]), d = $t(Xu), f = {
    x: Pa(e.x),
    y: Pa(e.y)
  }, u = Rv([f.x, f.y], ([b, v]) => b || v ? 1 : "unset");
...
const Un = /* @__PURE__ */ J(Bv);
const Hv = Vp("Search", [
  ["circle", { cx: "11", cy: "11", r: "8", key: "4ej97u" }],
  ["path", { d: "m21 21-4.3-4.3", key: "1qie3q" }]
]);
var Vv = ["cx", "cy", "innerRadius", "outerRadius", "gridType", "radialLines"];
function hr(t) {
...
function Gv(t, e, n) {
  return e = qv(e), e in t ? Object.defineProperty(t, e, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : t[e] = n, t;
}
function qv(t) {
  var e = Kv(t, "string");
...
var Jv = function(e, n, r, i) {
  ...
  return /* @__PURE__ */ Q.createElement("path", Mt({}, i, {
    ...
    key: "path-".concat(r),
    d: Jv(n, e.cx, e.cy, e.polarAngles)
  }));
}, Zv = function(e) {
  ...
  return !n || !n.length ? null : /* @__PURE__ */ Q.createElement("g", {
    ...
    var s = o;
    return r === "circle" ? /* @__PURE__ */ Q.createElement(Qv, Mt({
      key: s
    }, e, {
      radius: i,
      index: o
    })) : /* @__PURE__ */ Q.createElement(Xv, Mt({
      key: s
    }, e, {
      radius: i,
      index: o
  ...
  var n = e.cx, r = n === void 0 ? 0 : n, i = e.cy, o = i === void 0 ? 0 : i, s = e.innerRadius, a = s === void 0 ? 0 : s, c = e.outerRadius, d = c === void 0 ? 0 : c, f = e.gridType, u = f === void 0 ? "polygon" : f, h = e.radialLines, m = h === void 0 ? !0 : h, p = Wv(e, Vv);
  return d <= 0 ? null : /* @__PURE__ */ Q.createElement("g", {
    className: "recharts-polar-grid"
  }, /* @__PURE__ */ Q.createElement(Yv, Mt({
    cx: r,
    cy: o,
    innerRadius: a,
    outerRadius: d,
    gridType: u,
    radialLines: m
  }, p)), /* @__PURE__ */ Q.createElement(Zv, Mt({
    cx: r,
    cy: o,
    innerRadius: a,
    outerRadius: d,
...
var $o, ja;
function tx() {
  return ja || (ja = 1, $o = ex()), $o;
}
var nx = tx();
const rx = /* @__PURE__ */ jd(nx);
var ix = ["key"];
function Pn(t) {
  "@babel/helpers - typeof";
...
function cx(t, e, n) {
  return e = Ti(e), dx(t, ef() ? Reflect.construct(e, n || [], Ti(t).constructor) : e.apply(t, n));
}
function dx(t, e) {
...
var Or = /* @__PURE__ */ (function(t) {
  function e() {
    ...
    for (var r = arguments.length, i = new Array(r), o = 0; o < r; o++)
      i[o] = arguments[o];
    return n = cx(this, e, [].concat(i)), Ot(n, "state", {
...
Ot(Or, "getComposedData", function(t) {
  ...
  return c && d.forEach(function(h) {
    if (Array.isArray(h.value)) {
      var m = rx(h.value), p = _a(m) ? void 0 : e.scale(m);
      u.push(ze(ze({}, h), {}, {
        radius: p
      }, ur(s, a, p, h.angle)));
    } else
...
}], kx = ({ spin: t = !1, size: e = "md", background: n, hover: r = !1, ...i }, o) => {
...
}, rf = J(kx), of = zt(null), Cx = 15, Nx = ({ children: t, enabled: e, onShow: n, ...r }) => {
  const [i, o] = F(e), [s, a] = F(!1), [c, d] = F(!0), [f, u] = F(Cx), h = W(null), m = (b) => {
    h.current = b;
  }, p = () => {
    h.current && h.current();
  };
...
const sf = ({ className: t, disabled: e }) => {
  const { enabled: n, setOpen: r, open: i } = lo(), o = X(), [s, a] = F(!1);
  return n ? l("div", {
    className: "flex items-center",
    children: l(Kp, {
      children: g(Jp, {
...
}, Ix = ({ isMarked: t, onChange: e, label: n }) => {
  const [r, i] = F(!1), o = () => {
    i(!0), e(!t);
  };
  return l(Ae, {
...
}, Ax = ({ currentModule: t, label: e, getUpdates: n, updatesPageUrl: r, emptyScreen: i, errorScreen: o, onOpenChange: s = () => {
}, onHeaderClick: a = () => {
}, onItemClick: c = () => {
...
}, Tx = ({ title: t, href: e, mediaUrl: n, unread: r, updated: i, onClick: o }) => {
...
}), _x = ({ title: t, buttonText: e, buttonUrl: n, description: r }) => l(af, {
  title: t,
  description: r,
  icon: l(q, {
    icon: Ud,
...
}), Lx = ({ title: t, description: e, buttonText: n, onClick: r }) => l(af, {
  title: t,
  description: e,
...
}), Rx = ({ isVisible: t, onClose: e, crossSelling: n, onDropdownClose: r }) => {
  const [i, o] = F(t);
  V(() => {
    o(t);
  }, [t]);
...
function v_({ module: t, statusTag: e = void 0, breadcrumbs: n = [], actions: r = [], embedded: i = !1, navigation: o, productUpdates: s, favorites: a }) {
...
const Ei = (t, e) => e.view.domAtPos(t).node.offsetParent !== null, Mx = (t, e, n) => {
  ...
  const { state: n, view: r, extensionManager: i } = t, { schema: o, selection: s } = n, { empty: a, $anchor: c } = s, d = !!i.extensions.find((x) => x.name === "gapCursor");
  if (!a || c.parent.type !== o.nodes.detailsSummary || !d || e === "right" && c.parentOffset !== c.parent.nodeSize - 2)
    return !1;
  const f = Il((x) => x.type === o.nodes.details)(s);
  if (!f)
    return !1;
  ...
  addCommands() {
    return {
      ...
      unsetDetails: () => ({ state: t, chain: e }) => {
        ...
        if (!i)
          return !1;
        const o = si(i.node, (x) => x.type === r.nodes.detailsSummary), s = si(i.node, (x) => x.type === r.nodes.detailsContent);
...
var ye = class {
  ...
  static get(t) {
    return ws(t) || ks(t, jx(t));
  }
};
function jx(t) {
  if (t.type.spec.tableRole != "table")
    throw new RangeError("Not a table node: " + t.type.name);
  const e = Bx(t), n = t.childCount, r = [];
  let i = 0, o = null;
  const s = [];
...
function Hx(t, e, n) {
  ...
  for (let i = 0; i < t.map.length; i++) {
    ...
    for (let d = 0; d < c.colspan; d++) {
      ...
      u != null && (!c.colwidth || c.colwidth[d] != u) && ((a || (a = Vx(c)))[d] = u);
    }
...
var pe = class _t extends Qe {
  ...
  // cell.
  constructor(e, n = e) {
    const r = e.node(-1), i = ye.get(r), o = e.start(-1), s = i.rectBetween(
      e.pos - o,
      n.pos - o
  ...
  forEachCell(e) {
    const n = this.$anchorCell.node(-1), r = ye.get(n), i = this.$anchorCell.start(-1), o = r.cellsInRect(
      r.rectBetween(
  ...
  static colSelection(e, n = e) {
    const r = e.node(-1), i = ye.get(r), o = e.start(-1), s = i.findCell(e.pos - o), a = i.findCell(n.pos - o), c = e.node(0);
  ...
  getBookmark() {
    return new Kx(this.$anchorCell.pos, this.$headCell.pos);
  }
};
...
function Xx(t, e, n) {
  ...
  } else r instanceof st && Yx(r) ? o = st.create(i, r.from) : r instanceof st && Qx(r) && (o = st.create(i, r.$from.start(), r.$from.end()));
  return o && (e || (e = t.tr)).setSelection(o), e;
}
var Zx = new Ue("fix-tables");
function pf(t, e, n, r) {
...
function gf(t, e) {
  let n;
  const r = (i, o) => {
    i.type.spec.tableRole == "table" && (n = ey(t, i, o, n));
  };
...
function ey(t, e, n, r) {
  ...
  return r.setMeta(Zx, { fixTables: !0 });
}
function At(t) {
  const e = t.selection, n = ao(t), r = n.node(-1), i = n.start(-1), o = ye.get(r);
...
function bf(t, { map: e, tableStart: n, table: r }, i) {
  let o = i > 0 ? -1 : 0;
  qx(e, r, i + o) && (o = i == 0 || i == e.width ? null : 0);
...
function ry(t, { map: e, table: n, tableStart: r }, i) {
...
function iy(t, e) {
  ...
  if (e) {
    ...
    for (let i = n.right - 1; ry(r, n, i), i != n.left; i--) {
...
function vf(t, { map: e, tableStart: n, table: r }, i) {
  ...
  const a = [];
  let c = i > 0 ? -1 : 0;
  oy(e, r, i + c) && (c = i == 0 || i == e.height ? null : 0);
...
function ay(t, { map: e, table: n, tableStart: r }, i) {
  let o = 0;
...
function cy(t, e) {
  ...
  if (e) {
    ...
    for (let i = n.bottom - 1; ay(r, n, i), i != n.top; i--) {
      const o = n.tableStart ? r.doc.nodeAt(n.tableStart - 1) : r.doc;
      if (!o)
        throw RangeError("No table found");
...
function dy({ width: t, height: e, map: n }, r) {
...
function Za(t, e) {
  const n = Pe(t.schema);
  return uy(({ node: r }) => n[r.type.spec.tableRole])(t, e);
}
function uy(t) {
  return (e, n) => {
    var r;
...
function pr(t, e) {
  return e = e || { useDeprecatedLogic: !1 }, e.useDeprecatedLogic ? hy(t) : function(n, r) {
    if (!bt(n)) return !1;
    if (r) {
...
function tc(t) {
  return function(e, n) {
    ...
    if (n) {
      ...
      n(
        e.tr.setSelection(st.between(i, Gx(i))).scrollIntoView()
      );
    }
    return !0;
  };
...
function ic(t, e, n, r, i) {
  ...
  function m() {
    if (o = n ? u.doc.nodeAt(n - 1) : u.doc, !o)
      throw new Error("No table found");
    s = ye.get(o), h = u.mapping.maps.length;
  }
  yy(u, s, o, n, d, f, h) && m(), nc(u, s, o, n, c, d, a, h) && m(), nc(u, s, o, n, c, d, f, h) && m(), rc(u, s, o, n, a, f, c, h) && m(), rc(u, s, o, n, a, f, d, h) && m();
  for (let p = a; p < f; p++) {
...
function Cy(t, e, n) {
  ...
  if (i instanceof pe) {
    ...
    const o = i.$anchorCell.node(-1), s = i.$anchorCell.start(-1), a = ye.get(o).rectBetween(
      i.$anchorCell.pos - s,
      i.$headCell.pos - s
    );
    return r = xy(r, a.right - a.left, a.bottom - a.top), ic(t.state, t.dispatch, s, a, r), !0;
  } else if (r) {
    ...
    return ic(
      ...
      t.dispatch,
      s,
      ye.get(o.node(-1)).findCell(o.pos - s),
      r
    ), !0;
  } else
    return !1;
  ...
  const o = new It({
    ...
    state: {
      init(s, a) {
        ...
        return r && f && (f[u] = (h, m) => new r(h, n, m)), new Ay(-1, !1);
      },
      apply(s, a) {
        return a.apply(s);
      }
...
function Ty(t, e, n, r) {
  ...
  if (i && !i.dragging) {
    ...
    if (s != i.activeHandle) {
      if (!r && s !== -1) {
        const a = t.state.doc.resolve(s), c = a.node(-1), d = ye.get(c), f = a.start(-1);
...
function Ey(t, e, n, r) {
  ...
  if (!s || s.activeHandle == -1 || s.dragging)
    return !1;
  const a = t.state.doc.nodeAt(s.activeHandle), c = _y(t, s.activeHandle, a.attrs);
  t.dispatch(
...
function _y(t, e, { colspan: n, colwidth: r }) {
...
function Oy(t, e, n) {
  const r = t.state.doc.resolve(e), i = r.node(-1), o = ye.get(i), s = r.start(-1), a = o.colCount(r.pos - s) + r.nodeAfter.attrs.colspan - 1, c = t.state.tr;
  for (let d = 0; d < o.height; d++) {
    ...
    const p = h.colwidth ? h.colwidth.slice() : Ry(h.colspan);
    p[m] = n, c.setNodeMarkup(s + u, null, { ...h, colwidth: p });
  }
  c.docChanged && t.dispatch(c);
}
function ac(t, e, n, r) {
  const i = t.state.doc.resolve(e), o = i.node(-1), s = i.start(-1), a = ye.get(o).colCount(i.pos - s) + i.nodeAfter.attrs.colspan - 1;
...
function Fy(t, e) {
  ...
  if (!o)
    return fr.empty;
  const s = ye.get(o), a = i.start(-1), c = s.colCount(i.pos - a) + i.nodeAfter.attrs.colspan - 1;
...
function qy(t, e, n = {}) {
  var r;
  const i = (r = n.cellLineSeparator) != null ? r : Uy;
  ...
  t.content.forEach((p) => {
    ...
    p.content && p.content.forEach((v) => {
      ...
      const w = Gy(x), y = v.type === "tableHeader";
...
var Ky = qy, Jy = gt.create({
  ...
  renderHTML({ node: t, HTMLAttributes: e }) {
    const { colgroup: n, tableWidth: r, tableMinWidth: i } = By(t, this.options.cellMinWidth), o = e.style;
    function s() {
  ...
  addCommands() {
    return {
      ...
      addColumnBefore: () => ({ state: t, dispatch: e }) => ty(t, e),
      addColumnAfter: () => ({ state: t, dispatch: e }) => ny(t, e),
      deleteColumn: () => ({ state: t, dispatch: e }) => iy(t, e),
      addRowBefore: () => ({ state: t, dispatch: e }) => sy(t, e),
      addRowAfter: () => ({ state: t, dispatch: e }) => ly(t, e),
      deleteRow: () => ({ state: t, dispatch: e }) => cy(t, e),
      deleteTable: () => ({ state: t, dispatch: e }) => gy(t, e),
      ...
      toggleHeaderCell: () => ({ state: t, dispatch: e }) => my(t, e),
      mergeOrSplit: () => ({ state: t, dispatch: e }) => Xa(t, e) ? !0 : Za(t, e),
      setCellAttribute: (t, e) => ({ state: n, dispatch: r }) => fy(t, e)(n, r),
  ...
  addExtensions() {
    const t = [];
    return this.options.table !== !1 && t.push(Jy.configure(this.options.table)), this.options.tableCell !== !1 && t.push(Py.configure(this.options.tableCell)), this.options.tableHeader !== !1 && t.push(zy.configure(this.options.tableHeader)), this.options.tableRow !== !1 && t.push($y.configure(this.options.tableRow)), t;
  }
});
const Qy = Yy.configure({
  table: {
    resizable: !0
  }
});
...
function e1(t) {
  ...
  for (; ++r < n.length; ) {
    const i = n[r];
    e.push([t1(i[0]), n1(i[1])]);
  }
  return e;
}
function t1(t) {
  return typeof t == "string" ? new RegExp(Xy(t), "g") : t;
}
function n1(t) {
...
function d1(t) {
  Zy(
    ...
    [
      [/(https?:\/\/|www(?=\.))([-.\w]+)([^ \t\r\n]*)/gi, u1],
      [new RegExp("(?<=^|\\s|\\p{P}|\\p{S})([-.\\w+]+)@([-\\w]+(?:\\.[-\\w]+)+)", "gu"), f1]
    ],
...
function u1(t, e, n, r, i) {
  let o = "";
  if (!wf(i) || (/^w/i.test(e) && (n = e + n, e = "", o = "http://"), !h1(n)))
    return !1;
  const s = m1(n + r);
  if (!s[0]) return !1;
  const a = {
...
function N1() {
  return {
    enter: {
      gfmFootnoteCallString: p1,
      gfmFootnoteCall: g1,
      gfmFootnoteDefinitionLabelString: b1,
      gfmFootnoteDefinition: v1
    },
    exit: {
      gfmFootnoteCallString: x1,
      gfmFootnoteCall: y1,
      gfmFootnoteDefinitionLabelString: w1,
...
function R1(t, e) {
  const n = e || {}, r = (n.align || []).concat(), i = n.stringLength || O1, o = [], s = [], a = [], c = [];
  let d = 0, f = -1;
  for (; ++f < t.length; ) {
    const b = [], v = [];
    let x = -1;
...
function H1(t, e, n, r) {
  const i = B1(n), o = t.value || "", s = i === "`" ? "GraveAccent" : "Tilde";
  if (j1(t, n)) {
    const u = n.enter("codeIndented"), h = n.indentLines(o, V1);
    return u(), h;
  }
  const a = n.createTracker(r), c = i.repeat(Math.max($1(o, i) + 1, 3)), d = n.enter("codeFenced");
  let f = a.move(c);
  if (t.lang) {
...
Sf.peek = G1;
function Sf(t, e, n, r) {
  const i = U1(n), o = n.enter("emphasis"), s = n.createTracker(r), a = s.move(i);
  let c = s.move(
...
function rw(t, e, n, r) {
  ...
  let s = t.ordered ? nw(n) : Ml(n);
  const a = t.ordered ? s === "." ? ")" : "." : tw(n);
...
Rf.peek = dw;
function Rf(t, e, n, r) {
  const i = cw(n), o = n.enter("strong"), s = n.createTracker(r), a = s.move(i + i);
  let c = s.move(
    n.containerPhrasing(t, {
      after: i,
      before: a,
...
function hw(t, e, n) {
  const r = (Of(n) + (n.options.ruleSpaces ? " " : "")).repeat(fw(n));
...
function Ew(t, e, n) {
  ...
  function c(u) {
    return u === 46 ? t.check(Tw, f, d)(u) : u === 45 || u === 95 || ul(u) ? (o = !0, t.consume(u), c) : f(u);
  }
  function d(u) {
...
function _w(t, e, n) {
  ...
  return i;
  function i(s) {
    return s !== 87 && s !== 119 || !Bf.call(r, r.previous) || Pl(r.events) ? n(s) : (t.enter("literalAutolink"), t.enter("literalAutolinkWww"), t.check(Aw, t.attempt(Mf, t.attempt(Pf, o), n), n)(s));
  }
  function o(s) {
...
function Vw(t, e, n) {
  ...
  function f(p) {
    ...
    if (p === 93) {
      ...
      return o = Tr(r.sliceSerialize(b)), t.enter("gfmFootnoteDefinitionLabelMarker"), t.consume(p), t.exit("gfmFootnoteDefinitionLabelMarker"), t.exit("gfmFootnoteDefinitionLabel"), h;
    }
...
function Ww(t, e, n) {
  return t.check(lg, e, t.attempt(zw, e, n));
}
function Uw(t) {
...
function qw(t) {
  ...
  function o(s, a, c) {
    ...
    function m(p) {
      ...
      if (u < 2 && !n) return c(p);
      const v = s.exit("strikethroughSequenceTemporary"), x = wi(p);
...
function Zw(t, e) {
  ...
  for (c !== 0 && gc(h, e, c, d, f), h.consume(e.events), n = -1; ++n < e.events.length; ) {
    const m = e.events[n];
    m[0] === "enter" && m[1].type === "table" && (m[1]._align = Yw(e.events, n));
  }
  return t;
}
...
function sk(t) {
  const e = (
    /** @type {Processor<Root>} */
    this
  ), n = t || ok, r = e.data(), i = r.micromarkExtensions || (r.micromarkExtensions = []), o = r.fromMarkdownExtensions || (r.fromMarkdownExtensions = []), s = r.toMarkdownExtensions || (r.toMarkdownExtensions = []);
  i.push(ik(n)), o.push(Sw()), s.push(Iw(n));
}
const lk = dg().use(ug).use(sk).use(fg).use(hg), ak = J(function({ content: e, className: n, format: r = "html", ...i }, o) {
  const s = z(() => Zd.sanitize(r === "markdown" ? String(lk.processSync(e)) : e, {
    ADD_ATTR: ["target"],
...
}), ck = J(function({ title: e, onClose: n, content: r, primaryAction: i, secondaryAction: o }, s) {
  return g("div", {
    ref: s,
...
}, vk = ({ config: t, isLoading: e, onButtonClick: n }) => g("div", {
  className: "flex flex-col gap-2",
...
}), kk = wk, Gf = ["paragraph", "heading", "blockquote", "codeBlock", "bulletList", "orderedList", "listItem", "table", "details"], bc = new Set(Gf), Ck = mn.create({
  name: "blockId",
  addGlobalAttributes() {
    return [{
      types: Gf,
...
var Nk = ({ key: t, editor: e, onPaste: n, onDrop: r, allowedMimeTypes: i }) => new It({
...
const Ik = /(?:^|\s)(!\[(.+|:?)]\((\S+)(?:(?:\s+)["'](\S+)["'])?\))$/, Ak = gt.create({
  ...
  const i = n.maxFileSize ?? Tk, { onError: o } = n;
...
const Lk = ({ node: t, deleteNode: e, updateAttributes: n }) => {
...
}), Rk = Ok, Fk = ({ aiBlockConfig: t, translations: e, imageUploadConfig: n }) => _s({
  aiBlockConfig: t,
  translations: e,
  imageUploadConfig: n
...
const Mk = ({ aiBlockConfig: t, translations: e, imageUploadConfig: n }) => mn.create({
  name: "slashCommand",
  addOptions() {
    return {
      suggestion: {
...
`],
  ...
  addProseMirrorPlugins() {
    return [v0({
      ...
      items: ({ query: r }) => {
        const i = r.toLowerCase().trim(), o = Fk({
          translations: e,
          aiBlockConfig: t,
          imageUploadConfig: n
        }).filter((s) => {
...
}), Pk = ({ node: t, deleteNode: e, updateAttributes: n }) => {
  const r = X(), [i, o] = F(t.attrs.isOpen ?? !1), s = t.attrs.data;
  if (!s) return null;
  const a = () => {
    const u = !i;
...
}, Wk = ({ enabled: t = !1, greeting: e, title: n, description: r, benefits: i, actions: o, onShow: s, onHide: a, children: c }) => l(Nx, {
  enabled: t,
  greeting: e,
  title: n,
  description: r,
...
}, Gk = se("AiPromotionChat", Uk), qk = se("AiPromotionChatProvider", Wk), Yf = St({
...
}, Kk = J(function({ title: e, onClose: n, children: r, actions: i = [], variant: o }, s) {
  if (i.length > 2)
  ...
  return g("div", {
    ...
    children: [g("div", {
      className: "flex flex-row items-center justify-between px-4 py-2",
      children: [g("div", {
        className: C("flex flex-row items-center gap-2", xc[o]),
        children: [vc[o] && l(q, {
          icon: vc[o],
          size: "sm",
          "aria-hidden": !0
        }), l(Ve, {
          className: xc[o] || "font-medium",
          children: e
        })]
      }), n && l(j, {
        variant: "ghost",
...
}), Jk = ({ compact: t, variant: e = "ai" }) => g("div", {
  className: Yf({
    variant: e
  }),
  "aria-busy": "true",
  ...
  ref: e,
  ...t
})), Yk = ({ compact: t, variant: e }) => l(Jk, {
  compact: t,
  variant: e
});
Qf.displayName = "F0Callout";
const y_ = Ne(Qf, Yk), Qk = ({ data: t, dataConfig: e, scaleMin: n, scaleMax: r, aspect: i }, o) => {
...
function rC({ elements: t, children: e, isEditMode: n, disallowOptionalQuestions: r, onChange: i, allowedQuestionTypes: o }) {
  const s = z(() => {
...
const jl = () => {
  ...
  label: "Emojis",
  value: "emojis"
}], iC = ({ label: t, icon: e, checked: n, onChange: r }) => l(sr, {
...
}), oC = ({ label: t, value: e, questionTypes: n, currentRatingType: r, onSelectQuestionType: i, onSelectRatingType: o }) => {
...
function sC({ open: t, setOpen: e, questionId: n, questionType: r, canDeleteQuestion: i = !0 }) {
  const { t: o } = X(), { onQuestionChange: s, getQuestionById: a, deleteElement: c, onDuplicateElement: d, disallowOptionalQuestions: f } = Je(), u = z(() => a(n), [n, a]), h = jl(), m = z(() => {
    if (r !== "rating" || !u || !("options" in u) || u.type !== "rating")
      return null;
    const y = u.options;
    return !Array.isArray(y) || y.length === 0 || typeof y[0]?.value != "number" ? null : Zf(y);
  }, [r, u]), p = (y) => {
    s?.({
      id: n,
      type: r,
...
const Nc = {
...
}, dC = ({ option: t, selected: e, onClick: n, onChangeLabel: r, isEditMode: i, disabled: o, isEmojiMode: s = !1 }) => {
  ...
  fieldSizing: "content"
}, mC = ({ index: t, option: e, selected: n, onClick: r, onClickAction: i, onChangeLabel: o, isEditMode: s, correct: a, locked: c }) => {
  const { value: d, label: f } = e, { isDragging: u, setIsDragging: h, setDraggedItemId: m, draggedItemId: p } = co(), { t: b } = X(), v = u && p === d, x = () => {
    s || r(d);
  }, w = (N) => {
    i({
      value: d,
  ...
  fieldSizing: "content"
}, xC = ({ id: t, title: e, description: n, questions: r = [], locked: i }) => {
  ...
  const { isEditMode: t, onAddNewElement: e, lastElementId: n } = Je(), r = jl(), { t: i } = X(), o = (c) => {
    e?.({
      type: c,
      afterId: n
    });
...
}, k_ = ({ elements: t, isEditMode: e, onChange: n, disallowOptionalQuestions: r, allowedQuestionTypes: i, applyingChanges: o }) => {
...
function kC({ title: t, isActive: e = !1, onClick: n }) {
  return g("button", {
    type: "button",
...
function CC({ author: t, timestamp: e, onClick: n, isActive: r }) {
...
function NC({ title: t, versions: e, currentVersion: n, activeVersionId: r }) {
  return g("nav", {
...
const C_ = se("F0VersionHistory", NC), rh = J(({ height: t, itemCount: e, itemSize: n, className: r, renderer: i }, o) => {
...
const SC = ({ entity: t, selected: e, onSelect: n, onRemove: r, marginLeft: i, search: o, goToFirst: s, goToLast: a, singleSelector: c = !1, disabled: d = !1, hiddenAvatar: f = !1 }) => {
...
const Sc = ({ label: t, onCreate: e, goToFirst: n, goToLast: r }) => l("div", {
...
}, IC = ({ actions: t, selectAllLabel: e, clearLabel: n, disabled: r, allVisibleSelected: i, anyVisibleSelected: o, loading: s, singleSelector: a, onSelectAll: c, onClear: d }) => {
...
}, AC = ({ search: t, onSearch: e, searchPlaceholder: n, disabled: r = !1, goToFirst: i, goToLast: o }) => {
  const s = (a) => {
  ...
  }, [k, I, N, e, U, O, R, t, n, _, s, o, p, i, r, T]), ae = z(() => t ? e.flatMap((P) => {
    const Y = Xr(h ?? [], P.id);
    return [{
      parent: null,
      subItem: {
  ...
  }, [ae, h, i, T, O, R, o, s, n, N, p, r, c, a, _, k, I]), [H, le] = z(() => {
    if (!e.length)
      return [!1, !1];
    let P = 0, Y = 0;
    if (!t)
...
}), LC = ({ groupView: t, onSubItemRemove: e, onRemove: n, selectedEntities: r, selectedLabel: i, disabled: o = !1, hiddenAvatar: s = !1 }) => {
  const a = z(() => {
  ...
  const [i, o] = F(t.entities), [s, a] = F(""), [c, d] = qg("", 300), f = z(() => t.entities.some((k) => k.subItems && k.subItems.length > 0), [t.entities]);
  function u(k) {
    if (t.singleSelector) {
      t.onSelect(k), n(!1);
      return;
  ...
  const x = (k) => {
    ...
    t.onItemExpandedChange(k.id, I), o(i.map((T) => T.id === k.id ? {
      ...T,
      expanded: !k.expanded
    } : T));
  };
  ...
  return Wn(() => {
    ...
    children: [l(vl, {
      ...
      children: t.children ? t.children : l(RC, {
...
var Jn = "ToggleGroup", [oh] = Kg(Jn, [
  ...
  if (n === "multiple")
    return /* @__PURE__ */ l(PC, { ...r, ref: e });
  throw new Error(`Missing prop \`type\` expected on \`${Jn}\``);
});
Bl.displayName = Jn;
var [lh, ah] = oh(Jn), MC = Q.forwardRef((t, e) => {
  const {
    value: n,
    defaultValue: r,
    onValueChange: i = () => {
...
Bl.displayName = Jn;
var [zC, $C] = oh(Jn), ch = Q.forwardRef(
  (t, e) => {
    const {
    ...
    return /* @__PURE__ */ l(zC, { scope: n, rovingFocus: i, disabled: r, children: i ? /* @__PURE__ */ l(
      Xg,
      {
        asChild: !0,
        ...d,
...
), Oi = "ToggleGroupItem", dh = Q.forwardRef(
  (t, e) => {
    const n = ah(Oi, t.__scopeToggleGroup), r = $C(Oi, t.__scopeToggleGroup), i = sh(t.__scopeToggleGroup), o = n.value.includes(t.value), s = r.disabled || t.disabled, a = { ...t, pressed: o, disabled: s }, c = Q.useRef(null);
...
}), jC = Fe.forwardRef(({ className: t, variant: e, size: n, ...r }, i) => l(hu, {
  ref: i,
  className: C(hh({
    variant: e,
    size: n,
...
function I_({ submitLabel: t, form: e }) {
  return l("div", {
    children: l(j, {
      type: "submit",
      label: t,
...
const BC = ({ id: t, createdAt: e, title: n, description: r, icon: i, category: o, isUnread: s = !1, onClick: a, onVisible: c }) => {
  const { ref: d } = fs({
    threshold: 0.1,
    onChange(h) {
      h && c?.(t);
...
}), Hl = se("ActivityItem", Ne(BC, HC)), bh = ({ title: t, children: e }) => g("div", {
  children: [l("div", {
...
}), VC = ({ title: t, items: e, onClickItem: n, onItemVisible: r }) => l(bh, {
  title: t,
  ...
  return g("div", {
    ...
    }, f)), e && new Array(UC).fill(null).map((f, u) => l(Hl.Skeleton, {}, u))]
  });
}, JC = () => {
  const t = X();
  return g("div", {
...
function Ko({ item: t, collapse: e = !1 }) {
  ...
  switch (n.type) {
    ...
    case "date": {
      ...
      const { icon: r, iconColor: i, textColor: o } = QC[n.icon];
      return g("div", {
...
const XC = (t) => t?.type !== "copy", ZC = (t) => t?.type === "copy";
function eN({ item: t }) {
      ...
      children: [l("div", {
        ...
        children: e && o && g(G.div, {
          ...
          children: [l("div", {
            ...
            children: t.actions?.map((a, c) => ZC(a) ? l(Zg, {
...
}), Ms = se("Metadata", tN), Jo = (t) => t.isVisible !== !1;
function nN({ title: t, avatar: e, deactivated: n, description: r, primaryAction: i, secondaryActions: o = [], otherActions: s = [], status: a, metadata: c = [] }) {
  const d = [a && {
    label: a.label,
    value: {
      type: "status",
    ...
    actions: a.actions,
    hideLabel: !0
  }, ...c], f = o.filter(Jo), u = s.filter(Jo), h = i && Jo(i), m = f.length > 0, p = u.length > 0, b = (x) => !!x && "items" in x, v = (x) => !!x && "label" in x && !("items" in x);
  return g("div", {
...
const rN = ({ avatar: t, title: e, description: n, primaryAction: r, secondaryActions: i, otherActions: o, status: s, metadata: a, deactivated: c }) => l(nN, {
  avatar: t,
  title: e,
  description: n,
  primaryAction: r,
...
function sN({ firstName: t, lastName: e, src: n, canReact: r, lastEmojiReaction: i, onReactionSelect: o, pickerRef: s }) {
  return g("div", {
    className: C("relative h-32 w-full overflow-hidden rounded-md bg-f1-background", n ? "" : oN[eb([t, e].join(""))]),
    children: [n && l("div", {
...
const aN = ({ link: t, firstName: e, lastName: n, src: r, onClick: i, canReact: o = !0, lastEmojiReaction: s, onReactionSelect: a, type: c, typeLabel: d, date: f }) => {
...
}), __ = Ne(aN, cN), L_ = ({ title: t, subtitle: e, buttonLabel: n, onClick: r }) => g("div", {
...
function dN({ emoji: t, initialCount: e, hasReacted: n = !1, users: r, onInteraction: i }) {
...
function uN({ items: t, onInteraction: e, locale: n, action: r }) {
  return g("div", {
...
const fN = se("Reactions", uN), Rc = (t) => {
  t.stopPropagation();
}, hN = ({ content: t, collapsed: e }) => {
...
}), vh = Ne(hN, mN), Fc = ({ tags: t, right: e }) => l("div", {
...
}), pN = /* @__PURE__ */ new Set(["avi", "mkv", "mov", "mpeg", "mp4", "webm", "wmv"]), xh = (t) => {
  if (!t) return !1;
  if (t.indexOf("//s3.") >= 0)
...
}, xN = ({ withEvent: t, withImage: e }) => g("div", {
...
}), O_ = Ne(vN, xN), yN = ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"], wN = J(function({ daysOfTheWeek: e = yN, activatedDays: n = [] }, r) {
...
}), kN = 750, CN = ({ text: t, children: e }) => {
  const [n, r] = F(!1);
  V(() => {
    if (n) {
      const o = setTimeout(() => r(!1), kN);
...
const NN = ({ children: t, action: e, ...n }) => {
  const r = e.type;
  switch (r) {
    case "copy":
      return l(CN, {
...
const SN = se("DataList.Item", Nh), Sh = J(({ action: t, avatarUrl: e, firstName: n, lastName: r }, i) => {
  const o = `${n} ${r}`;
  return l(Rr, {
    ref: i,
    leftIcon: () => l(Ct, {
...
const IN = se("PersonItem", Sh), Ih = J(({ avatarUrl: t, name: e, action: n }, r) => l(Rr, {
  ref: r,
  leftIcon: () => l(bu, {
    name: e,
    size: "xs",
...
const AN = se("CompanyItem", Ih), Ah = J(({ action: t, name: e }, n) => l(Rr, {
  ref: n,
  leftIcon: () => l(sb, {
    name: e,
    size: "xs"
...
const TN = se("TeamItem", Ah), Th = J(({ ...t }, e) => l("li", {
  ref: e,
...
const DN = se("DotTagItem", Th), ho = (t, e) => t && t.type === "copy" ? {
...
}), LN = J(function({ title: e, content: n, isHorizontal: r = !1, spacingAtTheBottom: i }, o) {
  ...
  return l("div", {
    ...
    children: l(Sn, {
      label: e,
      isHorizontal: r,
      children: s.map((a, c) => l(_N, {
        content: a
      }, c))
    })
  });
}), ON = se("DetailsItem", LN), RN = J(function({ title: e, tableView: n = !1, details: r }, i) {
  return g("div", {
    ref: i,
    className: "flex flex-col gap-4",
    children: [!!e && l("p", {
...
const M_ = se("ApplicationFrame", MN), PN = ({ contentId: t }) => {
  const e = X();
  return l("a", {
    href: `#${t}`,
...
function $N(t, e) {
  ...
  V(() => {
    e && zN(t, i.current, n) && r({
      isInvokedByUser: !1
    }), i.current = t;
  }, [t, e, n, r]);
}
function jN({ ai: t, aiPromotion: e, children: n, sidebar: r, banner: i }) {
...
function VN({ label: t, options: e, hasNewUpdate: n }) {
  return l("div", {
...
_h.displayName = "Page";
const $_ = se("Page", _h);
function WN({ companies: t, selected: e, onChange: n, isLoading: r = !1, withNotification: i = !1, additionalOptions: o = [] }) {
...
const UN = ({ companies: t, selected: e, onChange: n, children: r, additionalOptions: i = [] }) => {
...
function j_({ user: t, options: e, showActivityButton: n = !1, activityButtonShortcut: r, onActivityButtonClick: i, onDropdownClick: o, hasActivityUpdates: s }) {
  const a = X();
  return g("div", {
...
function B_({ companies: t, selected: e, onChange: n, withNotification: r = !1, additionalOptions: i, isLoading: o = !1 }) {
  return g("div", {
...
const YN = ({ item: t, active: e }) => g("div", {
...
function H_({ tree: t, onCollapse: e, onSort: n, onFavoritesChange: r, favorites: i }) {
...
function ZN({ nonSortableItems: t, sortableItems: e, setSortableItems: n, containerRef: r, onCollapse: i, onDragEnd: o, favorites: s = [], onFavoritesChange: a, forceUpdate: c, disableDragging: d = !1 }) {
  const f = X(), { isDragging: u } = Vl(), h = t.some((O) => O.isRoot), m = t.filter((O) => !O.isRoot).length > 0, p = e.length > 0, b = W(null), [v, x] = F(s), w = s.length > 0;
  V(() => {
    JSON.stringify(s) !== JSON.stringify(v) && x(s);
  }, [s]);
  const y = (O) => {
    x(O);
  }, D = ne((O) => {
...
const eS = ({ tooltip: t, children: e }) => t ? l(dt, {
  description: t,
  children: e
}) : e;
function V_({ onClick: t, placeholder: e, shortcut: n = ["cmd", "k"], ...r }) {
  return l("div", {
    className: "px-3",
    children: g("button", {
      onClick: t,
...
function W_({ header: t, body: e, footer: n, onFooterDropdownClick: r }) {
...
const tS = {
  ...
  warning: 1,
  neutral: 0
}, iS = (t) => t in zc ? zc[t] : nS;
function $c(t) {
  return rS[t ?? "neutral"] ?? 0;
}
const oS = ({ title: t, approvalsRequired: e = 1, status: n, approvers: r }) => {
...
}, aS = 2, cS = (t) => "items" in t, dS = (t) => "label" in t && !("items" in t), jc = (t) => t.every(cS) ? t : t.every(dS) ? [{
  items: t
}] : t.map((e) => ({
  items: e
})), uS = (t) => t ? typeof t == "function" ? jc(t() || []) : "actions" in t ? jc(t.actions() || []) : [] : [], fS = (t) => t.map((e) => ({
  ...e,
...
const mS = (t) => Array.isArray(t) ? t.every((e) => hS(e)) ? t : [{
  items: t
...
}), pS = ({ isOpen: t, secondaryActions: e = [], selectedNumber: n = void 0, onUnselect: r, warningMessage: i, ...o }) => {
  const s = X(), a = n === 1 ? s.status.selected.singular : s.status.selected.plural, c = e.slice(0, 2), d = e.slice(2).map((p) => ({
    ...p,
    critical: p.critical || !1
  })), f = z(() => mS(o.primaryActions ?? []), [o.primaryActions]), u = z(() => f.map((p) => ({
    ...p,
    items: p.items.map((b) => ({
      value: b.label,
      label: b.label,
...
}, gS = ({ primaryActions: t, secondaryActions: e, otherActions: n }) => {
...
function vS({ filter: t, value: e, onChange: n }) {
  const r = X(), i = {
    granularity: "day",
    ...t
...
const xS = (t) => "date" in t, yS = {
  ...
  icon: yu,
  className: "text"
}), wS = ({ value: t, onChange: e, loading: n = !1 }) => {
  ...
  return t ? (t.some((n) => Uc.includes(n)) && kS.forEach((n) => {
    e.add(n);
...
function AS(t, { filters: e, onError: n } = {}) {
  const [r, i] = F(void 0);
  return {
    ...Nb(t, {
      filters: e,
...
function TS({ totalPages: t, currentPage: e = 1, onPageChange: n, showControls: r = !0, ariaLabel: i = "Page navigation", visibleRange: o = 3, hasNextPage: s = !0, disabled: a = !1 }) {
  const c = t === 0, d = ne((u) => {
    n && (c || u >= 1 && u <= t) && n(u);
  }, [n, t, c]), f = z(() => {
    if (c) return [];
...
const DS = se("OnePagination", TS), Wl = ({ paginationInfo: t, setPage: e, className: n }) => {
  ...
  }, [d.dataAdapter]), { data: b, paginationInfo: v, setPage: x, isInitialLoading: w } = mo({
    ...d,
    dataAdapter: p
  }, {
    onError: (_) => {
...
const OS = ({ source: t, lane: e, onError: n, onHookUpdate: r }) => {
  const i = z(() => LS(t.currentFilters, e.filters), [t.currentFilters, e.filters]), o = mo(t, {
    filters: i,
    onError: n
  });
  return V(() => {
...
function RS(t, e = {}) {
  ...
  return {
    lanesProvider: z(() => (n || []).map((v) => l(OS, {
      lane: v,
      onError: e.onError,
      source: t,
      onHookUpdate: (x) => s(v.id, x)
...
const FS = (t) => {
  ...
  V(() => {
    ...
    n?.({
      ...FS(o.selectItemsStatus),
      byLane: d
    }, a);
  }, [o]);
  const c = z(() => (t || []).map((d) => l(MS, {
    source: e,
    data: d.data || {
      type: "flat",
      records: [],
...
function $S(t) {
  ...
  for (const r of t) {
    ...
    const i = r.split(" ");
    for (const o of i) {
      const s = o.startsWith("_") ? o.slice(0, zS) : o;
      e[s] = o;
    }
  }
  let n = "";
...
}, jS = "var(--ds-border-width-selected, 2px)", BS = {
  top: "horizontal",
  bottom: "horizontal",
  left: "vertical",
  right: "vertical"
...
function GS(t) {
  var e = t.edge, n = t.gap, r = n === void 0 ? "0px" : n, i = t.indent, o = i === void 0 ? "0px" : i, s = t.strokeColor, a = s === void 0 ? Vh.default : s, c = t.strokeWidth, d = c === void 0 ? jS : c, f = t.type, u = f === void 0 ? "terminal" : f, h = BS[e];
...
}, QS = ({ label: t, variant: e, count: n, onPrimaryAction: r }) => {
  const i = !!r;
  return g("div", {
...
function XS({ title: t, items: e, renderCard: n, getKey: r, emptyState: i, fetchMore: o, variant: s = "neutral", loading: a = !1, hasMore: c = !1, loadingMore: d = !1, total: f, onPrimaryAction: u, onFooterAction: h, dropPlaceholderIndex: m }) {
  const p = {
    ...
    return tv({
      ...
      onDrop: async ({ location: L, source: O }) => {
        ...
        if (ae ? te && te.data ? H = nI({
          ...
          toLaneId: t,
          sourceId: R
        }) : le === "sameLaneOverCard" && te && te.data ? H = eI({
          cardTarget: te,
          fromLaneId: Z,
          toLaneId: t,
          sourceId: R
...
function qc(t) {
  ...
  const D = (k, I) => {
    ...
    try {
      const H = N == null ? null : A[O].items[N], le = await o?.onMove?.(I, T, $, H ? {
        record: H,
        position: _ ?? "above"
      } : null);
      return le && d((te) => {
...
const oI = ({ lanes: t, title: e, description: n, avatar: r, metadata: i, onMove: o, onCreate: s, source: a, onSelectItems: c, onLoadError: d, onLoadData: f }) => {
  const { lanesProvider: u, lanesHooks: h } = RS(a, {
    onError: (A) => d(A)
  }), m = Nu();
  ...
  children: t
}), sI = (t, e) => (t && t(e) || []).filter((n) => n.type === "separator" || n.enabled === void 0 || n.enabled), lI = (t) => t ? t.indeterminate || t.selectedCount !== void 0 && t.selectedCount > 0 && !t.checked ? "indeterminate" : t.checked : !1, Kc = (t) => (t || []).map((e) => e.type === "separator" ? e : {
  ...e,
  type: "item"
}), Kh = ({
  source: t,
  ...
  const s = sI(t.itemActions, e), a = s.filter(
    (u) => u.type === "primary"
  ).slice(0, 2), c = Kc(
    s.filter(
...
}, aI = ({ title: t, avatar: e, description: n }) => g("article", {
...
}), cI = ({ source: t, item: e, selectedItems: n, handleSelectItemChange: r, fields: i, itemDefinition: o }) => {
  const s = X(), { actions: a } = s, c = (w, y) => Jh(w, y, "list", s), d = t.itemUrl ? t.itemUrl(e) : void 0, f = t.itemOnClick ? t.itemOnClick(e) : void 0, u = t.selectable ? t.selectable(e) : void 0, h = o(e), { primaryItemActions: m, dropdownItemActions: p, mobileDropdownItemActions: b, handleDropDownOpenChange: v, dropDownOpen: x } = Kh({
    source: t,
    item: e
  });
  return g("div", {
...
}, Lt = (t) => t.id ?? t.label ?? "column", mI = (t) => [...t].sort((e, n) => (e.order ?? t.length) - (n.order ?? t.length)).map((e) => Lt(e)), pI = (t) => t.filter((e) => e.hidden && !e.noHiding).map((e) => Lt(e)), Qh = (t, e, n, r, i) => {
  const o = () => {
    ...
    (r && n?.order !== void 0 ? n.order : void 0) ?? mI(t)
  );
  V(() => {
...
}, gI = ({ item: t, onChangeVisibility: e, allowSorting: n, allowHiding: r }) => {
...
}, bI = ({ items: t, onChange: e, allowSorting: n, allowHiding: r }) => {
  const i = (s) => {
...
}, vI = ({ columns: t, frozenColumns: e, allowSorting: n, allowHiding: r }) => {
  const i = X(), { settings: o, setVisualizationSettings: s } = go(), { columnsWithStatus: a } = Qh(t, e, o.visualization.table, n, r), c = z(() => a.filter((h) => r || h.visible).map((h) => ({
    id: h.column.id,
...
}, xI = (t) => !t.allowColumnHiding && !t.allowColumnReordering ? null : l(vI, {
  columns: t.columns,
...
const wI = {
  auto: void 0,
  fit: 1
}, kI = (t) => typeof t == "number", om = (t) => kI(t) ? t : wI[t], ql = zt(void 0);
function sm() {
  const t = $t(ql);
  if (!t)
...
const bo = 32, Ri = 24, fi = 18, CI = "1px", Gt = 8, lm = 32, am = 4, js = 40, NI = js - Ri, Kl = ({
  depth: t,
  padding: e = 0
}) => `${t * bo + e}px`, SI = ({
  depth: t,
...
}, _I = "h-full overflow-visible before:absolute before:-left-[var(--line-left)] before:top-[40px] before:h-[var(--line-height)] before:w-[var(--line-width)] before:bg-f1-foreground-disabled before:content-['']", LI = "after:absolute after:left-[var(--horizontal-left)] after:top-[var(--horizontal-offset)] after:h-[var(--horizontal-height)] after:w-[var(--connector-width)] after:rounded-bl-[var(--horizontal-height)] after:content-[''] after:shadow-[inset_1px_-1px_0_0_hsl(var(--neutral-30))]", OI = ({ firstCell: t, nestedRowProps: e }) => {
  const n = cm(t, e?.depth ?? 0), r = II(e?.expanded ?? !1, t), i = e === void 0 || e?.nestedVariant === "basic", o = e?.nestedVariant === "detailed", s = i || e?.rowWithChildren, a = o && e?.onLoadMoreChildren, c = n ? Kl({
    depth: e?.depth ?? 0,
    padding: 0
...
function hi({ children: t, width: e = "auto", sortState: n = "none", onSortClick: r, info: i, infoIcon: o = Yi, sticky: s, hidden: a = !1, align: c = "left", className: d }) {
  const { isScrolled: f, isScrolledRight: u } = sm(), h = s?.left !== void 0, m = s?.right !== void 0, p = h || m, b = s?.left ?? 0, v = s?.right ?? 0, x = r || i, w = l(ee, {
    children: g("div", {
...
function RI({ children: t, loading: e = !1 }) {
...
const hm = (t, e, n) => {
  ...
  return Wn(() => {
    ...
    const m = !i || i.getBoundingClientRect().top === 0, p = () => m ? (n.getBoundingClientRect().top ?? 0) - Gt / 2 : (i?.getBoundingClientRect().top ?? 0) - Gt / 2, b = () => m ? n.getBoundingClientRect().bottom - Gt : (i?.getBoundingClientRect().bottom ?? 0) - Gt, v = () => n.getBoundingClientRect().top ?? 0 - Gt, x = () => h.getBoundingClientRect().height, w = () => e && t === "basic" ? am : 0, y = () => {
  ...
  return t;
}, jI = (t) => t ? typeof t == "object" && "type" in t && t.type === "detailed" : !1, Xc = (t) => t ? Array.isArray(t) ? t : t.records : [], Zc = (t) => t && jI(t) ? t?.type ?? "basic" : "basic", BI = ({
  rowId: t,
  item: e,
  source: n,
  ...
  V(() => {
    ...
    (S || k || I) && (c([]), f(void 0), p("basic"), s(), r(), b.current = n.currentFilters, v.current = n.currentSortings, x.current = n.currentNavigationFilters);
  }, [
    n.currentFilters,
    n.currentSortings,
...
}, VI = J(HI), WI = 5, UI = ({ rowRef: t, rowIndex: e, source: n, item: r, columns: i, frozenColumnsLeft: o, nestedRowProps: s, groupIndex: a, onCheckedChange: c, selectedItems: d, checkColumnWidth: f, tableWithChildren: u, shouldHideBorder: h }, m) => {
...
}, GI = J(UI), qI = ({ rowRef: t, ...e }, n) => {
  const r = e.source.childrenCount?.({
    item: e.item,
    pagination: e.paginationInfo
  }), i = e.paginationInfo ? e.paginationInfo.total ? Math.min(e.paginationInfo.perPage, e.paginationInfo.total - e.paginationInfo.currentPage * e.paginationInfo.perPage) : e.paginationInfo.perPage : void 0, o = r ?? i ?? WI;
  return l(ee, {
    children: Array.from({
      length: o
    }).map((s, a) => {
  ...
  const [n, r] = F(!1), i = W(null), o = `${t.nestedRowProps?.depth ?? 0}-${"id" in t.item ? t.item.id : t.index}`, { children: s, loadChildren: a, isLoading: c, childrenType: d, paginationInfo: f } = BI({
    rowId: o,
    item: t.item,
    source: t.source,
    onClearFetchedData: () => r(!1)
  }), u = n && c, h = n, m = n && f?.hasMore, { calculatedHeight: p, setFirstChildRef: b, setLastChildRef: v } = PI(d, !!m), x = ne((I) => {
...
}, YI = (t, e) => (t.nestedRowProps?.depth ?? 0) === 0 ? l(zI, {
  children: l(ed, {
    ...t,
    ref: e
  })
...
}, zn = J(QI), XI = ({ columns: t, source: e, frozenColumns: n = 0, onSelectItems: r, onLoadData: i, onLoadError: o, allowColumnHiding: s, allowColumnReordering: a }) => {
  const c = X(), [d] = F(() => G.create(zn)), { settings: f } = go(), { columns: u } = Qh(t, n, f.visualization?.table, a, s), { data: h, paginationInfo: m, setPage: p, isInitialLoading: b, isLoadingMore: v, loadMore: x, summaries: w } = mo(e, {
    onError: (B) => {
      o(B);
    }
  ...
  }, Z = e.grouping?.collapsible, ae = e.grouping?.defaultOpenGroups, { openGroups: K, setGroupOpen: H } = kl(h?.type === "grouped" ? h.groups : [], ae), le = u.length + (e.itemActions ? 1 : 0) + (e.selectable ? 1 : 0), { getStickyPosition: te, checkColumnWidth: re } = hm(I, u, !!e.selectable), ue = h?.records.some((B) => e.itemsWithChildren?.(B));
...
}, ZI = ({ visualization: t, source: e, onSelectItems: n, onLoadData: r, onLoadError: i, tmpFullWidth: o }) => {
  if (t.type === "custom")
    return t.component({
      source: e,
      onLoadData: r,
...
}, Zr = "__no-sorting__", eA = ({ currentSortings: t, sortings: e, onChange: n }) => {
  const r = X(), i = [{
...
}, tA = ({ visualizations: t, currentVisualization: e, onVisualizationChange: n }) => {
  const r = X(), i = (s) => {
    n(s);
  }, o = (s) => s.type === "custom" ? {
    icon: s.icon,
  ...
  return e;
}, gm = (t) => nA(t.type)?.settings.renderer ?? null, rA = (t) => {
  if (t.type === "custom")
    return !1;
  const e = gm(t);
...
}, oA = ({ visualizations: t, currentVisualization: e, onVisualizationChange: n, grouping: r, currentGrouping: i, onGroupingChange: o, sortings: s, currentSortings: a, onSortingsChange: c }) => {
  ...
  const pa = z(() => it !== void 0, [it]), ga = it === void 0 ? null : Zn !== void 0 ? it(Zn) : null, { settings: _o, setSettings: Lp } = go(), { storageReady: Op } = SS(c, typeof a == "object" ? a?.features ?? ["*"] : ["*"], {
    settings: {
      value: _o,
      setValue: Lp
    },
  ...
  }, [e, _, O]), Hr = z(() => vn || re || Lo || w && w.enabled, [vn, re, Lo, w]), yn = z(() => pa ? f ? "top" : "bottom" : !1, [f, pa]), wn = z(() => v ? Hr ? "top" : "bottom" : !1, [v, Hr]), Rp = z(() => yn === "top" || wn === "top", [yn, wn]), Fp = z(() => f || Hr || wn === "bottom" || yn === "bottom", [f, Hr, wn, yn]);
  return g("div", {
...
}), G_ = se("OneDataCollection", lA), q_ = (t, e = []) => {
  const n = X(), {
    navigationFilters: r,
    summaries: i,
...
const aA = se("Dialog", bm), K_ = pt({
  name: "Dialog",
  type: "info"
}, aA), at = () => /* @__PURE__ */ new Map(), Bs = (t) => {
  const e = at();
  ...
  for (const [n, r] of t)
    if (e(r, n))
      return !0;
  return !1;
}, cn = () => /* @__PURE__ */ new Set(), Xo = (t) => t[t.length - 1], uA = (t, e) => {
  for (let n = 0; n < e.length; n++)
    t.push(e[n]);
}, dn = Array.from, fA = (t, e) => {
...
const Pt = Math.floor, mi = Math.abs, $n = (t, e) => t < e ? t : e, Jt = (t, e) => t > e ? t : e, xm = (t) => t !== 0 ? t < 0 : 1 / t < 0, td = 1, nd = 2, Zo = 4, es = 8, br = 32, Rt = 64, $e = 128, hA = 1 << 29, vo = 31, Vs = 63, rn = 127, mA = 2147483647, ym = Number.MAX_SAFE_INTEGER, pA = Number.isInteger || ((t) => typeof t == "number" && isFinite(t) && Pt(t) === t), gA = String.fromCharCode, bA = (t) => t.toLowerCase(), vA = /^\s*/g, xA = (t) => t.replace(vA, ""), yA = /([A-Z])/g, rd = (t, e) => xA(t.replace(yA, (n) => `${e}${bA(n)}`)), wA = (t) => {
...
}, Us = new Uint8Array(3e4), AA = Us.length / 3, TA = (t, e) => {
  if (e.length < AA) {
...
class RA {
  ...
  toUint8Array() {
    const e = new Mr();
    return this.sarr.push(this.s), this.s = "", Tn(e, this.sarr.join("")), xo(e, this.lensE.toUint8Array()), lt(e);
  }
}
...
const Ql = (t) => new yo(t), FA = (t) => t.pos !== t.arr.length, MA = (t, e) => {
  const n = new Uint8Array(t.arr.buffer, t.pos + t.arr.byteOffset, e);
  return t.pos += e, n;
}, Ye = (t) => MA(t, ge(t)), xr = (t) => t.arr[t.pos++], ge = (t) => {
  let e = 0, n = 1;
  ...
  return t.pos += e, n;
}, $A = (t) => Zl(t, 4).getFloat32(0, !1), jA = (t) => Zl(t, 8).getFloat64(0, !1), BA = (t) => (
  /** @type {any} */
...
class ad extends yo {
  ...
  read() {
    return this.count === 0 && (this.s = this.reader(this), FA(this) ? this.count = ge(this) + 1 : this.count = -1), this.count--, /** @type {T} */
    this.s;
  }
}
class gi extends yo {
...
const WA = crypto.getRandomValues.bind(crypto), UA = Math.random, Cm = () => WA(new Uint32Array(1))[0], GA = (t) => t[Pt(UA() * t.length)], qA = "10000000-1000-4000-8000" + -1e11, KA = () => qA.replace(
  /[018]/g,
  /** @param {number} c */
...
let Nm = new YA(), QA = !0;
try {
  typeof localStorage < "u" && localStorage && (Nm = localStorage, QA = !1);
} catch {
}
const XA = Nm, ZA = Object.assign, Sm = Object.keys, e2 = (t, e) => {
  for (const n in t)
    e(t[n], n);
}, ud = (t) => Sm(t).length, t2 = (t) => {
  for (const e in t)
    return !1;
  return !0;
}, Im = (t, e) => {
  for (const n in t)
    if (!e(t[n], n))
      return !1;
  return !0;
}, n2 = (t, e) => Object.prototype.hasOwnProperty.call(t, e), r2 = (t, e) => t === e || ud(t) === ud(e) && Im(t, (n, r) => (n !== void 0 || n2(e, r)) && e[r] === n), i2 = Object.freeze, Am = (t) => {
  for (const e in t) {
    const n = t[e];
...
}, o2 = (t, e) => e.includes(t), Bn = typeof process < "u" && process.release && /node|io\.js/.test(process.release.name) && Object.prototype.toString.call(typeof process < "u" ? process : 0) === "[object process]", Tm = typeof window < "u" && typeof document < "u" && !Bn;
let yt;
const s2 = () => {
  if (yt === void 0)
    if (Bn) {
...
!Dm("no-color") && (!Bn || process.stdout.isTTY) && (!Bn || qs("--color") || Mi("COLORTERM") !== null || (Mi("TERM") || "").includes("color")), c2 = (t) => {
  ...
  for (let n = 0; n < t.byteLength; n++)
    e += gA(t[n]);
  return btoa(e);
}, d2 = (t) => Buffer.from(t.buffer, t.byteOffset, t.byteLength).toString("base64"), u2 = Tm ? c2 : d2, f2 = (t) => NA((e) => jn(e, t));
class h2 {
  /**
   * @param {L} left
   * @param {R} right
...
const p2 = (t) => cA(t, (e, n) => `${n}:${e};`).join(""), g2 = (t) => class {
  /**
...
const Qt = (t, e, n) => e.clients.forEach((r, i) => {
  ...
  return n !== void 0 && T2(n, e.clock) !== null;
}, ra = (t) => {
  t.clients.forEach((e) => {
...
class pn extends vm {
   ...
   */
  constructor({ guid: e = KA(), collectionid: n = null, gc: r = !0, gcFilter: i = () => !0, meta: o = null, autoLoad: s = !1, shouldLoad: a = !0 } = {}) {
...
class wo extends R2 {
  constructor() {
    super(), this.keyMap = /* @__PURE__ */ new Map(), this.keyClock = 0, this.keyClockEncoder = new ts(), this.clientEncoder = new pi(), this.leftClockEncoder = new ts(), this.rightClockEncoder = new ts(), this.infoEncoder = new od(Ws), this.stringEncoder = new RA(), this.parentInfoEncoder = new od(Ws), this.typeRefEncoder = new pi(), this.lenEncoder = new pi();
  }
  toUint8Array() {
    const e = Pr();
    return de(e, 0), Ge(e, this.keyClockEncoder.toUint8Array()), Ge(e, this.clientEncoder.toUint8Array()), Ge(e, this.leftClockEncoder.toUint8Array()), Ge(e, this.rightClockEncoder.toUint8Array()), Ge(e, lt(this.infoEncoder)), Ge(e, this.stringEncoder.toUint8Array()), Ge(e, lt(this.parentInfoEncoder)), Ge(e, this.typeRefEncoder.toUint8Array()), Ge(e, this.lenEncoder.toUint8Array()), xo(e, lt(this.restEncoder)), lt(e);
  }
  /**
   * @param {ID} id
   */
...
const F2 = (t, e, n, r) => {
  ...
  return null;
}, z2 = (t, e) => jm(t, e.doc.store, e.beforeState), $2 = (t, e, n, r = new Pi(t)) => he(e, (i) => {
  i.local = !1;
  let o = !1;
  const s = i.doc, a = s.store, c = M2(r, s), d = P2(i, a, c), f = a.pendingStructs;
  if (f) {
...
const hd = () => new j2(), md = (t, e) => t.l.push(e), pd = (t, e) => {
...
const H2 = (t, e, n = 0) => new B2(t, e, n), ti = (t, e, n) => {
  let r = null, i = null;
  ...
  if (i !== null) {
    if (ke(r, i.client) <= i.clock)
      return null;
    const f = n ? Zs(r, i) : V2(r, i), u = f.item;
    if (!(u instanceof me))
      return null;
...
const bd = (t, e) => e.deleteSet.clients.size === 0 && !dA(e.afterState, (n, r) => e.beforeState.get(r) !== n) ? !1 : (ra(e.deleteSet), z2(t, e), ia(t, e.deleteSet), !0), vd = (t, e, n) => {
  const r = e._item;
  ...
  if (e < t.length) {
    ...
    try {
      ...
      }), a.push(() => r.emit("afterTransaction", [n, r])), ea(a, []), n._needFormattingCleanup && pT(n);
    } finally {
      r.gc && K2(o, i, r.gcFilter), J2(o, i), n.afterState.forEach((f, u) => {
      ...
      if (!n.local && n.afterState.get(r.clientID) !== n.beforeState.get(r.clientID) && (I2(ta, _m, "[yjs] ", Lm, Om, "Changed the client-id because another client seems to be using it."), r.clientID = $m()), r.emit("afterTransactionCleanup", [n, r]), r._observers.has("update")) {
        const f = new O2();
  ...
  let o = !1, s = null;
  t._transaction === null && (o = !0, t._transaction = new q2(t, n, r), i.push(t._transaction), i.length === 1 && t.emit("beforeAllTransactions", [t]), t.emit("beforeTransaction", [t._transaction, t]));
  try {
    s = e(t._transaction);
  } finally {
    if (o) {
  ...
  constructor(e, {
    ...
    super(), this.scope = [], this.doc = a, this.addToScope(e), this.deleteFilter = i, o.add(this), this.trackedOrigins = o, this.captureTransaction = r, this.undoStack = [], this.redoStack = [], this.undoing = !1, this.redoing = !1, this.currStackItem = null, this.lastChange = 0, this.ignoreRemoteMapChanges = s, this.captureTimeout = n, this.afterTransactionHandler = (c) => {
      ...
      if (this.lastChange > 0 && m - this.lastChange < this.captureTimeout && u.length > 0 && !d && !f) {
        ...
        u.push(new Y2(c.deleteSet, h)), p = !0;
...
class X2 {
   ...
   */
  constructor(e, n) {
    this.gen = Q2(e), this.curr = null, this.done = !1, this.filterSkips = n, this.next();
  }
  /**
...
const eT = (t, e) => {
  ...
  let i = r.map((f) => new X2(f, !0)), o = null;
  const s = new n(), a = new Z2(s);
  for (; i = i.filter((h) => h.curr !== null), i.sort(
    ...
    if (o !== null) {
      ...
      if (u !== o.struct.id.client)
        ...
        p > 0 && (o.struct.constructor === ot ? o.struct.length -= p : h = eT(h, p)), o.struct.mergeWith(
          /** @type {any} */
          h
        ) || (rr(a, o.struct, o.offset), o = { struct: h, offset: 0 }, f.next());
      }
...
class Co {
   ...
   */
  get path() {
    return this._path || (this._path = nT(this.currentTarget, this.target));
  }
  /**
...
const iT = (t) => {
  ...
  let r = t._start, i = 0;
  for (n !== null && (r = n.p, i = n.index, iT(n)); r.right !== null && i < e; ) {
    if (!r.deleted && r.countable) {
      if (e < i + r.length)
        break;
      i += r.length;
  ...
  r.parent.length / Jm ? (Ym(n, r, i), n) : oT(t._searchMarker, r, i);
}, Cr = (t, e, n) => {
...
class _n extends De {
   ...
   */
  _callObserver(e, n) {
    super._callObserver(e, n), So(this, e, new cT(this, e));
  }
  /**
...
const fT = (t) => new Hn(), Kt = (t, e) => t === e || typeof t == "object" && typeof e == "object" && t && e && r2(t, e);
class Xs {
  /**
...
`;
  ...
  he(n, (r) => {
    Qt(t, t.deleteSet, (i) => {
      ...
      i.content.constructor === Ce ? e.add(o) : hT(r, i);
    });
    for (const i of e)
      mT(i);
  });
          ...
          if (a !== null) {
            ...
            switch (a) {
              ...
              case "insert":
                ...
                break;
              case "retain":
                f > 0 && (m = { retain: f }, t2(c) || (m.attributes = ZA({}, c))), f = 0;
                break;
            }
            m && n.push(m), a = null;
          }
...
class Oe extends un {
   ...
   */
  _write(e) {
    e.writeTypeRef(PT), e.writeKey(this.nodeName);
  }
}
const xT = (t) => new Oe(t.readKey());
class yT extends Co {
  /**
...
class Bi extends Hn {
   ...
   */
  _write(e) {
    e.writeTypeRef($T), e.writeKey(this.hookName);
  }
}
const wT = (t) => new Bi(t.readKey());
class He extends Xt {
  /**
   * @type {YXmlElement|YXmlText|null}
   */
...
class Xe extends ca {
   ...
   */
  write(e, n) {
    e.writeInfo(CT), e.writeLen(this.length - n);
  }
  /**
   * @param {Transaction} transaction
...
const ST = (t) => new Sr(t.readLen()), up = (t, e) => new pn({ guid: t, ...e, shouldLoad: e.shouldLoad || e.autoLoad || !1 });
class $r {
  /**
   * @param {Doc} doc
   */
...
const IT = (t) => new $r(up(t.readString(), t.readAny()));
class gn {
  /**
   * @param {Object} embed
   */
...
const TT = (t) => new Ce(t.readKey(), t.readJSON());
class Hi {
  /**
   * @param {Array<any>} arr
   */
...
const LT = (t) => new ht(t.readString()), OT = [
  dT,
  fT,
  bT,
  xT,
  ...
  wT,
  kT
], RT = 0, FT = 1, MT = 2, PT = 3, zT = 4, $T = 5, jT = 6;
class vt {
  /**
   * @param {AbstractType<any>} type
   */
...
let me = class el extends ca {
  ...
  gc(e, n) {
    if (!this.deleted)
      throw We();
    this.content.gc(e), n ? G2(e, this, new Xe(this.id, this.length)) : this.content = new Sr(this.length);
  }
  /**
   * Transform the properties of this type to binary and write it to an
   * BinaryEncoder.
...
class ot extends ca {
   ...
   */
  write(e, n) {
    e.writeInfo(VT), de(e.restEncoder, this.length - n);
  }
  /**
   * @param {Transaction} transaction
   * @param {StructStore} store
...
const WT = () => {
  ...
  for (; n < t.length && n < e.length && t[n] === e[n]; )
    n++;
  for (n > 0 && UT.test(t[n - 1]) && n--; r + n < t.length && r + n < e.length && t[t.length - r - 1] === e[e.length - r - 1]; )
    r++;
  return r > 0 && GT.test(t[t.length - r]) && r--, {
    index: n,
    remove: t.length - n - r,
    insert: e.slice(n, e.length - r)
  };
}, KT = qT, xe = new Ue("y-sync"), Ft = new Ue("y-undo");
new Ue("yjs-cursor");
const kt = (t, e) => t >>> e | t << 32 - e, JT = (t) => kt(t, 2) ^ kt(t, 13) ^ kt(t, 22), YT = (t) => kt(t, 6) ^ kt(t, 11) ^ kt(t, 25), QT = (t) => kt(t, 7) ^ kt(t, 18) ^ t >>> 3, XT = (t) => kt(t, 17) ^ kt(t, 19) ^ t >>> 10, ZT = new Uint32Array([
  1116352408,
  1899447441,
  3049323471,
  3921009573,
...
class tD {
  ...
  _updateHash() {
    ...
    for (let u = 16; u < 64; u++)
      n[u] = XT(n[u - 2]) + n[u - 7] + QT(n[u - 15]) + n[u - 16];
    let r = e[0], i = e[1], o = e[2], s = e[3], a = e[4], c = e[5], d = e[6], f = e[7];
    for (let u = 0, h, m; u < 64; u++)
      h = f + YT(a) + (a & c ^ ~a & d) + ZT[u] + n[u] >>> 0, m = JT(r) + (r & i ^ r & o ^ i & o) >>> 0, f = d, d = c, c = a, a = s + h >>> 0, s = o, o = i, i = r, r = h + m >>> 0;
  ...
  digest(e) {
    ...
    for (; n < e.length; i++)
      for (let s = 3; s >= 0 && n < e.length; s--)
        this._W[i] |= e[n++] << s * 8;
    r || (this._W[i - (n % 4 === 0 ? 0 : 1)] |= $e << (3 - n % 4) * 8), this._W[14] = e.byteLength / hA, this._W[15] = e.byteLength * 8, this._updateHash();
...
class cD {
  ...
  constructor(e, n = /* @__PURE__ */ new Map()) {
    this.type = e, this.prosemirrorView = null, this.mux = WT(), this.mapping = n, this.isOMark = /* @__PURE__ */ new Map(), this._observeFunction = this._typeChanged.bind(this), this.doc = e.doc, this.beforeTransactionSelection = null, this.beforeAllTransactions = () => {
  ...
  _isDomSelectionInView() {
    ...
    const i = n.getBoundingClientRect(), o = m2.documentElement;
...
const xD = (t) => Ft.getState(t)?.undoManager?.undo() != null, yD = (t) => Ft.getState(t)?.undoManager?.redo() != null, wD = /* @__PURE__ */ new Set(["paragraph"]), kD = (t, e) => !(t instanceof me) || !(t.content instanceof vt) || !(t.content.type instanceof Xt || t.content.type instanceof Oe && e.has(t.content.type.nodeName)) || t.content.type._length === 0, CD = ({ protectedNodes: t = wD, trackedOrigins: e = [], undoManager: n = null } = {}) => new It({
  ...
  state: {
    ...
    apply: (r, i, o, s) => {
      const a = xe.getState(s).binding, c = i.undoManager, d = c.undoStack.length > 0, f = c.redoStack.length > 0;
      return a ? {
        undoManager: c,
        prevSel: tl(a, o),
        hasUndoOps: d,
  ...
  view: (r) => {
    const i = xe.getState(r.state), o = Ft.getState(r.state).undoManager;
...
}), Q_ = ({ withHeader: t = !1, withTitle: e = !0, withToolbar: n = !0 }) => g("div", {
  className: "relative flex h-full w-full flex-col",
  "aria-busy": "true",
  "aria-live": "polite",
  children: [t && g("div", {
...
To.displayName = "VerticalOverflowList";
const aL = ({ events: t, showAllItems: e, gap: n = 8, minSize: r = 184 }) => t.length ? e ? l("div", {
  className: "flex flex-col",
...
function fL({ items: t, minSize: e = 184, onClickItem: n, showAllItems: r, onVisibleItemsChange: i }) {
  return r ? l("div", {
    className: "flex flex-col gap-2",
...
function hL({ items: t, gap: e, minSize: n = 184, onClickItem: r, showAllItems: i }) {
  return i ? l("div", {
    className: "flex flex-col",
    style: {
      minHeight: `${n}px`
...
}), mL = J(function({ title: e, titleValue: n, titleTooltip: r, list: i }, o) {
  return g("div", {
    ref: o,
    className: "flex flex-col gap-2",
    children: [e && g("div", {
...
function pL({ title: t, subtitle: e, data: n, helpText: r, legend: i = !1, hideTooltip: o = !1 }) {
  return g("div", {
    children: [g("div", {
...
function gL({ trackedMinutes: t, remainingMinutes: e, data: n = [], labels: r, locationId: i, locations: o, canShowLocation: s = !0, locationSelectorDisabled: a = !1, onClockIn: c, onClockOut: d, onBreak: f, breakTypes: u, onChangeBreakTypeId: h, canShowBreakButton: m = !0, canSeeGraph: p = !0, canSeeRemainingTime: b = !0, onChangeLocationId: v, canShowProject: x = !0, projectSelectorElement: w, breakTypeName: y }) {
  const { status: D, statusText: S, subtitle: k, statusColor: I } = IE({
    ...
    h?.(K), _(!1), f?.(K);
  }, O = T && o.length && !a && s, R = o.find((K) => K.id === i), $ = o.map((K) => ({
    value: K.id,
    label: K.name,
    icon: K.icon
  })), U = D === "break", [Z, ae] = F(!1);
...
function bL({ tasks: t, onClickTask: e, hideIcons: n = !1, maxTasksToShow: r = 5, emptyMessage: i = "No tasks assigned" }) {
  const s = [{
    key: "done",
    status: "done"
  }, {
...
}, []), n_ = ({ boxesRefs: t, wrapperRef: e, children: n, windowWidth: r, wrapperWidth: i }) => {
...
const u_ = {
  ...
  const i = u_[n], [o, s] = F(), a = Du.toArray(e), c = W(null);
  return V(() => {
    const d = () => {
...
function h_({ title: t, description: e, emoji: n, actions: r }) {
  if ((r?.length ?? 0) > 2)
...
const wL = se("WidgetSection", Ap), kL = ({ identifier: t, allowedRoutes: e, disallowedRoutes: n, children: r }) => {
  const i = Nu(), o = window.location.pathname, s = z(() => e?.length ? e.includes(o) : n?.length ? !n.includes(o) : !0, [o, e, n]), a = z(() => {
...
export {
  ...
  M_ as ApplicationFrame,
  tL as AreaChartWidget,
  eL as AutoGrid,
  db as Badge,
  nL as BarChartWidget,
  KC as BaseActivityItemList,
  PL as BaseBanner,
  aN as BaseCelebration,
  vN as BaseCommunityPost,
  IL as BaseTabs,
  AL as BreadcrumbSelect,
  yx as Breadcrumbs,
  Ps as CalendarEvent,
  ...
  lL as ChartWidgetEmptyState,
  gL as ClockInControls,
  k_ as CoCreationForm,
  O_ as CommunityPost,
  xN as CommunityPostSkeleton,
  WN as CompanySelector,
  _r as Counter,
  vL as Dashboard,
  P_ as DaytimePage,
  ON as DetailsItem,
  R_ as DetailsItemsList,
  K_ as Dialog,
  Me as Dropdown,
  N_ as EntitySelect,
  jL as F0ActionBar,
  ...
  y_ as F0Callout,
  BL as F0TableOfContent,
  C_ as F0VersionHistory,
  TL as F1SearchBox,
  HL as FILE_TYPES,
  VL as FileItem,
  S_ as Form,
  ...
  oL as VerticalBarChartWidget,
  vb as WeekStartDay,
  wN as Weekdays,
  Ln as Widget,
  uL as WidgetAvatarsListItem,
  yL as WidgetEmptyState,
  cL as WidgetHighlightButton,
  fL as WidgetInboxList,
  Rd as WidgetInboxListItem,
  wL as WidgetSection,
  hL as WidgetSimpleList,
  sl as WidgetSimpleListItem,
  xL as WidgetStrip,
  Qk as _RadarChart,
  yb as getGranularityDefinition,
  xb as getGranularityDefinitions,
  OL as getGranularitySimpleDefinition,
  ku as granularityDefinitions,
  RL as modules,
  KL as predefinedPresets,
  FL as rangeSeparator,
  JL as selectSizes,
