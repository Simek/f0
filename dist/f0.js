import { a6 as G, a7 as Ve, aa as Un, ab as Mi, ac as Ii, ad as ws, ae as Cs, af as Vn, ag as Se, u as Hi, ah as Fi, ai as _s, aj as Es, ak as Ss, al as Ds, am as pe, an as xe, ao as Rs, ap as Ns, aq as qn, ar as Ts, as as $t, at as Kn, au as Xn, av as Yn, aw as Zn, ax as Jn, ay as Qn, az as ks, aA as As, aB as Os, aC as zs, aD as Ps, a8 as Re, aE as pn, aF as Ls, aG as Ms, aH as nt, aI as Is, aJ as Hs, aK as Fs, aL as Bs, aM as Ws, aN as Gs, aO as $s, aP as js, aQ as Us, aR as Vs, aS as qs, aT as Ks, aU as er, aV as Xs, aW as Ys, aX as Zs, aY as Js, aZ as Qs, a_ as tr, a$ as eo, b0 as to, b1 as io, I as no, b2 as ro, b3 as so, b4 as oo, b5 as ao } from "./F0AiChat-XFGUtjD_.js";
import { A as bh, bk as yh, B as xh, C as wh, E as Ch, bz as _h, h as Eh, F as Sh, a as Dh, x as Rh, i as Nh, b as Th, b6 as kh, b7 as Ah, b8 as Oh, b9 as zh, bb as Ph, bc as Lh, bd as Mh, be as Ih, bf as Hh, bg as Fh, bh as Bh, bv as Wh, s as Gh, t as $h, v as jh, w as Uh, c as Vh, bl as qh, n as Kh, o as Xh, p as Yh, H as Zh, k as Jh, L as Qh, O as ef, bj as tf, q as nf, P as rf, S as sf, T as of, l as af, m as lf, U as cf, bw as df, bq as uf, r as hf, j as ff, bt as pf, bp as gf, bA as mf, bo as vf, bn as bf, ba as yf, d as xf, bm as wf, br as Cf, e as _f, bB as Ef, bi as Sf, bs as Df, g as Rf, f as Nf, by as Tf, bu as kf, bx as Af } from "./F0AiChat-XFGUtjD_.js";
import { jsx as h, jsxs as A, Fragment as Nt } from "react/jsx-runtime";
import I, { forwardRef as ge, useRef as M, useImperativeHandle as lo, Children as jt, createContext as Ne, useContext as ve, useState as B, useMemo as L, useEffect as H, useCallback as U, useLayoutEffect as Ni, createElement as gn, isValidElement as ir, Fragment as co, memo as uo, useReducer as ho, cloneElement as fo, PureComponent as po } from "react";
import { L as nr, C as go, i as rr, F as sr, D as mo, S as mn, a as vo, f as xi, b as gt, c as bo, A as yo, d as It, e as or, E as xo, g as Wt, h as wo, j as Co, k as _o, l as tt, m as ar, u as Eo, G as So, n as Do, o as vn, p as Ro, q as lr, r as No, B as cr, X as dr, Y as Ti, s as To, t as ur, v as ko, w as Ao, x as Oo, y as zo, z as Po, H as Lo, I as Mo, J as Io, K as bn, M as Ho, N as mt, O as wi, P as Fo, Q as Bo, R as Wo, T as Go, U as $o, V as jo, W as Uo, Z as Vo, _ as qo, $ as Ko, a0 as Xo, a1 as yn, a2 as Yo, a3 as Zo, a4 as hr, a5 as Jo, a6 as Qo, a7 as ea, a8 as Bi, a9 as ta, aa as ia, ab as na, ac as ra, ad as sa, ae as oa, af as aa, ag as la, ah as ca, ai as da, aj as ua, ak as ha, al as fa, am as fr, an as pa, ao as ga, ap as xn, aq as ma, ar as pr, as as va, at as ba, au as ya, av as xa } from "./DataCollectionStorageProvider-BCPKNj-I.js";
import { aN as zf, aw as Pf, ax as Lf, aA as Mf, aE as If, aF as Hf, aG as Ff, aI as Bf, aJ as Wf, aK as Gf, aL as $f, aD as jf, aH as Uf, ay as Vf, az as qf, aM as Kf, aB as Xf, aC as Yf, aO as Zf, aP as Jf, aQ as Qf, aR as ep } from "./DataCollectionStorageProvider-BCPKNj-I.js";
import { createPortal as gr, unstable_batchedUpdates as Ht } from "react-dom";
import { A as ip, F as np, c as rp, b as sp, a as op, o as ap, u as lp } from "./F0HILActionConfirmation-xY9rw8fp.js";
...
import './f0.css';const wa = {
  ...
  md: 2,
  lg: 2
}, Ca = ge(function({ widgets: e, children: t }, n) {
  const r = M(null);
  lo(n, () => r.current);
  const s = jt.toArray(e).filter((o) => !!o).map((o, a) => h("div", {
...
}), mr = I.forwardRef(({ children: i, variant: e, className: t, ...n }, r) => h(nr, {
  layout: "standard",
  children: h("section", {
    ref: r,
...
mr.displayName = "StandardLayout";
const Ea = ge(function({ children: e, sideContent: t, mainColumnPosition: n = "left", sticky: r = !1 }, s) {
  return h("div", {
    ref: s,
    className: "h-full",
    children: A("div", {
...
const Ra = ["noMove", "noResize", "locked", "w", "h", "x", "y"], Be = 200;
function Na(i) {
...
function Ta({ children: i, options: e, onResizeStop: t, onChange: n, widgets: r }) {
  const [s, o] = B(null), a = M(null), l = M(!1), d = L(() => ({
    ...e,
    children: (r || []).map((C) => it(C))
  }), [e, r]), [c, u] = B(() => {
  ...
  Un(() => {
    ...
    if (!Array.isArray(C))
      return;
    const D = C.map((k) => k.id), b = r || [], y = b.map((k) => k.id), m = b.filter((k) => !D.includes(k.id));
    ...
    const _ = C.filter((k) => !y.includes(k.id));
    if (_.length > 0) {
      const k = _.map((E) => E.id).filter(Boolean);
      k.forEach((E) => {
        setTimeout(() => {
        ...
        return k.forEach((T) => {
          if (R.get(T)) {
            const Q = s.el.querySelector(`[gs-id="${T}"] .grid-stack-item-content`);
            let ee = "";
            Q && (ee = Na(Q)), R.set(T, h(Mi.div, {
    ...
    const z = b.filter((k) => D.includes(k.id));
    if (z.length > 0) {
      const k = [];
      z.forEach((E) => {
        const R = C.find((F) => F.id === E.id);
        if (!R)
          return;
        const T = Ra.filter((F) => R[F] !== E[F]);
        if (T.length > 0) {
          const F = {}, Q = ["w", "h", "x", "y"], ee = ["noMove", "noResize", "locked"], K = T.filter((j) => Q.includes(j)), re = T.filter((j) => ee.includes(j));
          if (K.length > 0 && re.length > 0 && K.length + re.length === T.length ? re.forEach((j) => {
            const se = E[j];
            se !== void 0 && (F[j] = se);
          }) : T.forEach((j) => {
            const se = E[j];
      ...
      }), k.forEach(({ element: E, updateOptions: R }) => {
        try {
          s.update(E, R);
        } catch (T) {
  ...
  const N = U(() => {
    ...
    if (Array.isArray(C)) {
      const D = C.map((b) => {
        const y = b.id;
        if (!y) return null;
        const m = f.current.get(y), _ = v.current.get(y), z = b;
        return {
          ...b,
          id: y,
          w: b.w ?? 1,
...
const Aa = Ne(null);
function Oa() {
  const { _reactContentMap: i } = br(), { getWidgetContainer: e } = ka();
  return h(Nt, {
...
function Vt(i) {
  De.touchHandled || (De.touchHandled = !0, Ut(i, "mousedown"));
}
function qt(i) {
  De.touchHandled && Ut(i, "mousemove");
}
function Kt(i) {
  if (!De.touchHandled)
    return;
  ...
  Ut(i, "mouseup"), e || Ut(i, "click"), De.touchHandled = !1;
}
function Xt(i) {
  i.pointerType !== "mouse" && i.target.releasePointerCapture(i.pointerId);
}
function wn(i) {
  P.dragElement && i.pointerType !== "mouse" && xr(i, "mouseenter");
}
function Cn(i) {
  P.dragElement && i.pointerType !== "mouse" && (De.pointerLeaveTimeout = window.setTimeout(() => {
    delete De.pointerLeaveTimeout, xr(i, "mouseleave");
  }, 10));
}
class ai {
  constructor(e, t, n) {
  ...
  _init() {
    ...
    return e.classList.add("ui-resizable-handle"), e.classList.add(`${ai.prefix}${this.dir}`), e.style.zIndex = "100", e.style.userSelect = "none", this.host.appendChild(this.el), this.el.addEventListener("mousedown", this._mouseDown), me && (this.el.addEventListener("touchstart", Vt), this.el.addEventListener("pointerdown", Xt)), this;
  }
  /** call this when resize handle needs to be removed and cleaned up */
  destroy() {
    return this.moving && this._mouseUp(this.mouseDownEvent), this.el.removeEventListener("mousedown", this._mouseDown), me && (this.el.removeEventListener("touchstart", Vt), this.el.removeEventListener("pointerdown", Xt)), this.host.removeChild(this.el), delete this.el, delete this.host, this;
  }
  /** @internal called on mouse down on us: capture move on the entire document (mouse might not stay on us) until we release the mouse */
  _mouseDown(e) {
    this.mouseDownEvent = e, document.addEventListener("mousemove", this._mouseMove, { capture: !0, passive: !0 }), document.addEventListener("mouseup", this._mouseUp, !0), me && (this.el.addEventListener("touchmove", qt), this.el.addEventListener("touchend", Kt)), e.stopPropagation(), e.preventDefault();
  }
  /** @internal */
  _mouseMove(e) {
  ...
  /** @internal */
  _mouseUp(e) {
    this.moving && (this._triggerEvent("stop", e), document.removeEventListener("keydown", this._keyEvent)), document.removeEventListener("mousemove", this._mouseMove, !0), document.removeEventListener("mouseup", this._mouseUp, !0), me && (this.el.removeEventListener("touchmove", qt), this.el.removeEventListener("touchend", Kt)), delete this.moving, delete this.mouseDownEvent, e.stopPropagation(), e.preventDefault();
  }
...
class Ct extends Wi {
  ...
  /** @internal */
  _setupHandlers() {
    return this.handlers = this.option.handles.split(",").map((e) => e.trim()).map((e) => new ai(this.el, e, {
      start: (t) => {
        this._resizeStart(t);
      },
      stop: (t) => {
  ...
  /** @internal */
  _setupHelper() {
    this.elOriginStyleVal = Ct._originStyleProp.map((n) => this.el.style[n]), this.parentOriginStylePosition = this.el.parentElement.style.position;
  ...
  /** @internal */
  _cleanHelper() {
    return Ct._originStyleProp.forEach((e, t) => {
...
const Pa = 'input,textarea,button,select,option,[contenteditable="true"],.ui-resizable-handle';
class _t extends Wi {
  constructor(e, t = {}) {
  ...
  enable() {
    this.disabled !== !1 && (super.enable(), this.dragEls.forEach((e) => {
      e.addEventListener("mousedown", this._mouseDown), me && (e.addEventListener("touchstart", Vt), e.addEventListener("pointerdown", Xt));
    }), this.el.classList.remove("ui-draggable-disabled"));
  }
  disable(e = !1) {
    this.disabled !== !0 && (super.disable(), this.dragEls.forEach((t) => {
      t.removeEventListener("mousedown", this._mouseDown), me && (t.removeEventListener("touchstart", Vt), t.removeEventListener("pointerdown", Xt));
  ...
  _mouseDown(e) {
    if (!P.mouseHandled)
      return e.button !== 0 || !this.dragEls.find((t) => t === e.target) && e.target.closest(Pa) || this.option.cancel && e.target.closest(this.option.cancel) || (this.mouseDownEvent = e, delete this.dragging, delete P.dragElement, delete P.dropElement, document.addEventListener("mousemove", this._mouseMove, { capture: !0, passive: !0 }), document.addEventListener("mouseup", this._mouseUp, !0), me && (e.currentTarget.addEventListener("touchmove", qt), e.currentTarget.addEventListener("touchend", Kt)), e.preventDefault(), document.activeElement && document.activeElement.blur(), P.mouseHandled = !0), !0;
  }
  ...
  _mouseMove(e) {
    ...
    if (this.lastDrag = e, this.dragging)
      if (this._dragFollow(e), P.pauseDrag) {
        const n = Number.isInteger(P.pauseDrag) ? P.pauseDrag : 100;
      ...
      n ? P.dropElement = n.el.ddElement.ddDroppable : delete P.dropElement, this.helper = this._createHelper(), this._setupHelperContainmentStyle(), this.dragTransform = g.getValuesFromTransformedElement(this.helperContainment), this.dragOffset = this._getDragOffset(e, this.el, this.helperContainment), this._setupHelperStyle(e);
  ...
  _mouseUp(e) {
    if (document.removeEventListener("mousemove", this._mouseMove, !0), document.removeEventListener("mouseup", this._mouseUp, !0), me && e.currentTarget && (e.currentTarget.removeEventListener("touchmove", qt, !0), e.currentTarget.removeEventListener("touchend", Kt, !0)), this.dragging) {
  ...
  _keyEvent(e) {
    const t = this.el.gridstackNode, n = t?.grid || P.dropElement?.el?.gridstack;
    if (e.key === "Escape")
  ...
  _createHelper() {
    let e = this.el;
    return typeof this.option.helper == "function" ? e = this.option.helper(this.el) : this.option.helper === "clone" && (e = g.cloneNode(this.el)), e.parentElement || g.appendTo(e, this.option.appendTo === "parent" ? this.el.parentElement : this.option.appendTo), this.dragElementOriginStyle = _t.originStyleProp.map((t) => this.el.style[t]), e;
  }
  ...
  _removeHelperStyle() {
    if (this.helper.classList.remove("ui-draggable-dragging"), this.el.gridstackNode?.grid?.el.classList.remove("grid-stack-dragging"), !this.helper?.gridstackNode?._isAboutToRemove && this.dragElementOriginStyle) {
      ...
      t.style.transition = this.dragElementOriginStyle.transition = "none", _t.originStyleProp.forEach((r) => t.style[r] = this.dragElementOriginStyle[r] || null), setTimeout(() => t.style.transition = n, 50);
    }
...
_t.originStyleProp = ["width", "height", "transform", "transform-origin", "transition", "pointerEvents", "position", "left", "top", "minWidth", "willChange"];
class La extends Wi {
  constructor(e, t = {}) {
  ...
  _mouseLeave(e, t = !1) {
    ...
    if (this.option.out && this.option.out(n, this._ui(P.dragElement)), this.triggerEvent("dropout", n), P.dropElement === this && (delete P.dropElement, !t)) {
...
class Gi {
  ...
  setupDraggable(e) {
    return this.ddDraggable ? this.ddDraggable.updateOption(e) : this.ddDraggable = new _t(this.el, e), this;
  }
  cleanDraggable() {
    return this.ddDraggable && (this.ddDraggable.destroy(), delete this.ddDraggable), this;
  }
  setupResizable(e) {
    return this.ddResizable ? this.ddResizable.updateOption(e) : this.ddResizable = new Ct(this.el, e), this;
  }
  cleanResizable() {
    return this.ddResizable && (this.ddResizable.destroy(), delete this.ddResizable), this;
  }
  setupDroppable(e) {
    return this.ddDroppable ? this.ddDroppable.updateOption(e) : this.ddDroppable = new La(this.el, e), this;
  }
  cleanDroppable() {
...
class Ma {
  ...
  on(e, t, n) {
    return this._getDDElements(e).forEach((r) => r.on(t, (s) => {
      n(s, P.dragElement ? P.dragElement.el : s.target, P.dragElement ? P.dragElement.helper : null);
    })), this;
  }
  off(e, t) {
  ...
  _getDDElements(e, t) {
    ...
    return r.length ? r.map((o) => o.ddElement || (n ? Gi.init(o) : null)).filter((o) => o) : [];
  }
}
const ie = new Ma();
class O {
...
Note: ".grid-stack" is required for proper CSS styling and drag/drop, and is the default selector.`)), n;
  ...
  constructor(e, t = {}) {
    ...
    t.alwaysShowResizeHandle === "mobile" && (t.alwaysShowResizeHandle = me), this._setStaticClass();
    const l = t.engineClass || O.engineClass || ze;
  ...
  static setupDragIn(e, t, n, r = document) {
    t?.pause !== void 0 && (P.pauseDrag = t.pause), t = { appendTo: "body", helper: "clone", ...t || {} }, (typeof e == "string" ? g.getElements(e, r) : e).forEach((o, a) => {
...
function Ia({ children: i }) {
  const { _gridStack: { value: e, set: t }, options: n } = br(), r = M(/* @__PURE__ */ new Map()), s = M(null), o = M(n), a = U((c, u) => {
    if (u.id && u.grid) {
      let f = Ft.get(u.grid);
...
const $i = ({ options: i, widgets: e, onChange: t, className: n }) => {
  const r = L(() => JSON.stringify(e.map((l) => ({
    id: l.id,
    w: l.w,
    h: l.h,
    x: l.x,
...
const Ha = (i, e, t) => h("div", {
  children: i
}), li = ({ widgets: i = [], editMode: e = !1, onChange: t = () => {
}, WidgetWrapper: n = Ha, main: r = !1, deps: s }) => {
  const o = U((b, y, m) => h(Mi.div, {
    className: "h-full w-full",
    initial: {
      opacity: 0,
      scale: 0.8,
    ...
    const z = l(_, m), k = {
      ...
      meta: _.meta,
      _originalContent: z,
      content: o(z, _.meta, y)
    };
    return _.x !== void 0 && (k.x = _.x), _.y !== void 0 && (k.y = _.y), k;
  }), [c, u] = B(d(i, e)), f = M(e), p = M(i), x = M(!1), v = M(/* @__PURE__ */ new Map()), w = M(i);
  w.current = i;
  const S = M(s), N = L(() => {
    ...
    u(b), x.current || t(b.map((y) => {
      const m = w.current.find((_) => _.id === y.id);
      return {
        id: y.id,
        w: y.w ?? 1,
        h: y.h ?? 1,
  ...
  }, [t]), D = (b, y) => !b && !y ? !1 : !b || !y || b.length !== y.length ? !0 : b.some((m, _) => m !== y[_]);
  return H(() => {
    const b = f.current !== e, y = p.current !== i, m = S.current !== s && (S.current === void 0 || s === void 0 || Object.keys(S.current).length !== Object.keys(s).length || Object.keys(s).some((E) => S.current?.[E] !== s[E])), _ = /* @__PURE__ */ new Map();
    i.forEach((E) => {
      if (E.deps && E.deps.length > 0) {
        const R = v.current.get(E.id), T = N.get(E.id);
        _.set(E.id, D(R, T)), T ? v.current.set(E.id, T) : v.current.delete(E.id);
      }
    });
    ...
    const k = Array.from(_.values()).some((E) => E) || m;
    b && !y && !k ? (x.current = !0, u((E) => E.map((R) => {
      const T = i.find((Q) => Q.id === R.id);
      if (!T)
        return R;
      const F = l(T, s);
      return {
        ...
        meta: T.meta,
        _originalContent: F,
        content: o(F, T.meta, e)
      };
    }))) : (y || k) && u((E) => {
      const R = new Map(E.map((T) => [T.id, T]));
      return i.map((T) => {
        const F = R.get(T.id), Q = _.get(T.id) ?? !1;
        let ee;
        Q || !F ? ee = l(T, s) : ee = F._originalContent ?? l(T, s);
        const K = {
          id: T.id,
          h: F?.h ?? T.h ?? 1,
          w: F?.w ?? T.w ?? 1,
          ...
          meta: T.meta,
          _originalContent: ee,
          content: o(ee, T.meta, e)
        }, re = F?.x ?? T.x, j = F?.y ?? T.y;
        return re !== void 0 && (K.x = re), j !== void 0 && (K.y = j), K;
      });
...
}, Wa = ["append", "className", "pressed", "compact", "noTitle", "noAutoTooltip", "style", "variant", "loading", "emoji"], wr = ge((i, e) => {
...
const Ci = Ve({
  ...
  "info-strong": "p",
  code: "code"
}, ji = ge(({ content: i, variant: e, align: t, className: n, as: r, ellipsis: s, noEllipsisTooltip: o, markdown: a, ...l }, d) => {
  const c = r ?? Ga[e ?? "body"];
  if (s !== void 0)
    return h(ws, {
      ref: d,
...
const Pu = [
  ...
  const [d, c] = B(!1), [u, f] = B(!1), p = Hi(), x = (w) => {
    c(w);
  }, v = u || d;
  return H(() => {
    if (!r || !n) return;
...
const ja = Vn(_r, $a), Ua = ({ children: i, title: e, draggable: t = !1, actions: n, aiButton: r }) => h(ja, {
  title: e,
  draggable: t,
  actions: n,
  AIButton: r,
...
const Va = Ba("Dashboard", Er), Lu = pe("Dashboard", Va), qa = Ve({
...
}), Ka = (i) => (i || []).map((e) => e.items).reduce((e, t) => (e.length > 0 && e.push({
  type: "separator"
}), e.push(...t), e), []), Xa = (i) => {
...
}, ci = ge(({ children: i, variant: e = "default", className: t, draggable: n = !1, onDragStart: r, onDragEnd: s, onDrop: o, dragId: a, primaryAction: l, ...d }, c) => {
  const u = L(() => Xa(d.actions || []), [d.actions]), f = L(() => u.flatMap((x) => x.items), [u]), p = L(() => f.length > 0 || !!l, [f, l]);
  return A("div", {
    ref: c,
    className: G(qa({
      variant: e
...
ci.displayName = "Block";
ci.__isPageLayoutBlock = !0;
const Ya = ({ title: i = "", description: e, titleLevel: t = "h2", children: n, className: r, ...s }) => {
  if (!i) return null;
  const o = t;
  return A(ci, {
    ...s,
...
}, Za = Fa("BlockContent", Ya), Ja = (i) => !ir(i) || !i.type || typeof i.type == "string" || typeof i.type == "symbol" ? !1 : "__isPageLayoutBlock" in i.type, Qa = (i) => !ir(i) || !i.type || typeof i.type == "string" || typeof i.type == "symbol" ? !1 : "__isPageLayoutGroup" in i.type, Sr = (i, e, t) => {
  const n = jt.toArray(e);
  for (const r of n)
    t.includes("block") && Ja(r) || t.includes("group") && Qa(r) || console.warn(
      `${i}: Children components must inherit from PageLayoutBlock or PageLayoutGroup. Found:`,
      r
    );
}, Ui = ge(({ children: i, onSort: e, ...t }, n) => {
  Sr("GroupLinear", i, ["block"]);
  const [r, s] = B(jt.toArray(i));
  return H(() => {
    s(jt.toArray(i));
  }, [i]), H(() => {
    e?.(r);
...
function ne(i) {
  var e, t;
  return i ? at(i) ? i : Vi(i) && (e = (t = i.ownerDocument) == null ? void 0 : t.defaultView) != null ? e : window : window;
}
function qi(i) {
  const {
    Document: e
...
function Tt(i) {
  return at(i) ? !1 : i instanceof ne(i).HTMLElement;
}
function Dr(i) {
  return i instanceof ne(i).SVGElement;
}
function lt(i) {
  return i ? at(i) ? i.document : Vi(i) ? qi(i) ? i : Tt(i) || Dr(i) ? i.ownerDocument : document : document : document;
}
const be = di ? Ni : H;
function ui(i) {
  const e = M(i);
...
const rt = /* @__PURE__ */ Rr(1), St = /* @__PURE__ */ Rr(-1);
function il(i) {
...
function dl() {
  const [i] = B(() => /* @__PURE__ */ new Set()), e = U((n) => (i.add(n), () => i.delete(n)), [i]);
  return [U((n) => {
    let {
      type: r,
      event: s
...
function fl(i) {
  let {
    ...
    screenReaderInstructions: r = ul
  } = i;
  const {
    announce: s,
    announcement: o
  } = ll(), a = At("DndLiveRegion"), [l, d] = B(!1);
  if (H(() => {
    d(!0);
  }, []), cl(L(() => ({
    onDragStart(u) {
    ...
    return null;
  const c = I.createElement(I.Fragment, null, I.createElement(ol, {
    id: n,
    value: r.draggable
  }), I.createElement(al, {
    id: a,
...
const yl = (i) => {
  ...
  for (const o of n) {
    ...
    if (l) {
      const d = Sn(l), c = r.reduce((f, p, x) => f + gl(d[x], p), 0), u = Number((c / 4).toFixed(4));
      s.push({
        id: a,
        data: {
...
function fi(i, e) {
  ...
  function n(r) {
    ...
    if (!Tt(r) || Dr(r) || t.includes(r))
      return t;
    const s = ne(i).getComputedStyle(r);
    return r !== i && Tl(r, s) && t.push(r), Nl(r, s) ? t : n(r.parentNode);
  }
  return i ? n(i) : t;
}
function Or(i) {
...
function Ei(i) {
  return !di || !i ? null : at(i) ? i : Vi(i) ? qi(i) || i === lt(i).scrollingElement ? window : Tt(i) ? i : null : null;
}
function zr(i) {
  return at(i) ? i.scrollX : i.scrollLeft;
}
function Pr(i) {
  return at(i) ? i.scrollY : i.scrollTop;
}
function ki(i) {
  return {
    x: zr(i),
...
function Lr(i) {
  return !di || !i ? !1 : i === document.scrollingElement;
}
function Mr(i) {
  const e = {
    x: 0,
...
function Al(i, e, t, n, r) {
  ...
  return !d && s <= e.top + v.height ? (p.y = Z.Backward, x.y = n * Math.abs((e.top + v.height - s) / v.height)) : !c && l >= e.bottom - v.height && (p.y = Z.Forward, x.y = n * Math.abs((e.bottom - v.height - l) / v.height)), !f && a >= e.right - v.width ? (p.x = Z.Forward, x.x = n * Math.abs((e.right - v.width - a) / v.width)) : !u && o <= e.left + v.width && (p.x = Z.Backward, x.x = n * Math.abs((e.left + v.width - o) / v.width)), {
    direction: p,
    speed: x
  };
}
...
function Ir(i) {
  return i.reduce((e, t) => rt(e, ki(t)), ye);
}
function zl(i) {
...
const Ll = [["x", ["left", "right"], zl], ["y", ["top", "bottom"], Pl]];
class Ki {
  constructor(e, t) {
...
class Xi {
  constructor(e) {
    ...
    this.props = e, this.listeners = new vt(lt(t)), this.windowListeners = new vt(ne(t)), this.handleKeyDown = this.handleKeyDown.bind(this), this.handleCancel = this.handleCancel.bind(this), this.attach();
  }
  attach() {
    ...
    if (hi(e)) {
      ...
      if (u) {
        ...
        for (const v of x) {
          ...
          }, z = w === W.Right && !N || w === W.Left && !C, k = w === W.Down && !D || w === W.Up && !S;
          if (z && _.x !== u.x) {
            ...
            R ? p.x = v.scrollLeft - E : p.x = w === W.Right ? v.scrollLeft - b.x : v.scrollLeft - y.x, p.x && v.scrollBy({
              left: -p.x,
              behavior: a
            });
            break;
            ...
            R ? p.y = v.scrollTop - E : p.y = w === W.Down ? v.scrollTop - b.y : v.scrollTop - y.y, p.y && v.scrollBy({
              top: -p.y,
              behavior: a
            });
            break;
        ...
        this.handleMove(e, rt(St(u, this.referenceCoordinates), p));
      }
    }
  }
  handleMove(e, t) {
...
class Yi {
  constructor(e, t, n) {
    var r;
    n === void 0 && (n = Ml(e.event.target)), this.props = void 0, this.events = void 0, this.autoScrollEnabled = !0, this.document = void 0, this.activated = !1, this.initialCoordinates = void 0, this.timeoutId = null, this.listeners = void 0, this.documentListeners = void 0, this.windowListeners = void 0, this.props = e, this.events = t;
    const {
      event: s
    } = e, {
      target: o
    } = s;
    this.props = e, this.events = t, this.document = lt(o), this.documentListeners = new vt(this.document), this.listeners = new vt(n), this.windowListeners = new vt(ne(o)), this.initialCoordinates = (r = Jt(s)) != null ? r : ye, this.handleStart = this.handleStart.bind(this), this.handleMove = this.handleMove.bind(this), this.handleEnd = this.handleEnd.bind(this), this.handleCancel = this.handleCancel.bind(this), this.handleKeydown = this.handleKeydown.bind(this), this.removeTextSelection = this.removeTextSelection.bind(this), this.attach();
  }
  attach() {
    const {
      events: e,
    ...
    if (this.listeners.add(e.move.name, this.handleMove, {
      passive: !1
    }), this.listeners.add(e.end.name, this.handleEnd), e.cancel && this.listeners.add(e.cancel.name, this.handleCancel), this.windowListeners.add(fe.Resize, this.handleCancel), this.windowListeners.add(fe.DragStart, Rn), this.windowListeners.add(fe.VisibilityChange, this.handleCancel), this.windowListeners.add(fe.ContextMenu, Rn), this.documentListeners.add(fe.Keydown, this.handleKeydown), t) {
      if (n != null && n({
  ...
  handleStart() {
    ...
    e && (this.activated = !0, this.documentListeners.add(fe.Click, Il, {
      capture: !0
  ...
  handleMove(e) {
    ...
    if (!r)
      return;
    const l = (t = Jt(e)) != null ? t : ye, d = St(r, l);
    if (!n && a) {
      if (Nn(a)) {
...
function $l(i) {
  let {
    acceleration: e,
    activator: t = bt.Pointer,
    canScroll: n,
    draggingRect: r,
    enabled: s,
    interval: o = 5,
    order: a = ei.TreeOrder,
  ...
  const p = Ul({
    ...
    if (!y)
      return;
    const m = w.current.x * S.current.x, _ = w.current.y * S.current.y;
    y.scrollBy(m, _);
  }, []), b = L(() => a === ei.TreeOrder ? [...d].reverse() : d, [a, d]);
  H(
    () => {
      if (!s || !d.length || !N) {
        v();
      ...
      for (const y of b) {
        ...
        for (const E of ["x", "y"])
          p[E][z[E]] || (k[E] = 0, z[E] = 0);
        if (k.x > 0 || k.y > 0) {
          v(), C.current = y, x(D, o), w.current = k, S.current = z;
          return;
        }
      }
      w.current = {
...
function Ul(i) {
  ...
  return kt((r) => {
    ...
    return {
      x: {
        [Z.Backward]: r.x[Z.Backward] || s.x === -1,
        [Z.Forward]: r.x[Z.Forward] || s.x === 1
      },
      y: {
        [Z.Backward]: r.y[Z.Backward] || s.y === -1,
        [Z.Forward]: r.y[Z.Forward] || s.y === 1
      }
    };
  }, [t, e, n]);
}
...
function Kl(i, e) {
  ...
  const [s, o] = B(null), {
    ...
    measure: l,
    strategy: d
  } = r, c = M(i), u = w(), f = Et(u), p = U(function(S) {
    ...
    if (!S || S === kn || c.current !== i || s != null) {
      ...
      for (let C of i) {
        ...
        const D = C.node.current, b = D ? new Ki(l(D), D) : null;
...
function Ji(i, e) {
  return kt((t) => i ? t || (typeof e == "function" ? e(i) : i) : null, [e, i]);
}
function Xl(i, e) {
  return Ji(i, e);
}
...
const On = [];
function Ql(i) {
  const e = M(i), t = kt((n) => i ? n && n !== On && i && e.current && i.parentNode === e.current.parentNode ? n : fi(i) : On, [i]);
  return H(() => {
    e.current = i;
  }, [i]), t;
}
function ec(i) {
  const [e, t] = B(null), n = M(i), r = U((s) => {
    const o = Ei(s.target);
  ...
  }, [r, i]), L(() => i.length ? e ? Array.from(e.values()).reduce((s, o) => rt(s, o), ye) : Ir(i) : ye, [i, e]);
}
function zn(i, e) {
  e === void 0 && (e = []);
  const t = M(null);
...
function Br(i) {
  return L(() => i ? Rl(i) : null, [i]);
}
const Pn = [];
function nc(i, e) {
  e === void 0 && (e = ct);
  const [t] = i, n = Br(t ? ne(t) : null), [r, s] = B(Pn);
  function o() {
    s(() => i.length ? i.map((l) => Lr(l) ? n : new Ki(e(l), l)) : Pn);
  }
  const a = pi({
    callback: o
  });
...
const ac = {
  ...
  over: null,
  measureDroppableContainers: Qt
}, Ot = /* @__PURE__ */ Ne(Gr), $r = /* @__PURE__ */ Ne(ac);
function lc() {
  return {
    draggable: {
      active: null,
...
function dc(i) {
  ...
  const {
    ...
    activatorEvent: n,
    draggableNodes: r
  } = ve(Ot), s = Zt(n), o = Zt(t?.id);
  return H(() => {
    if (!e && !n && s && o != null) {
      if (!hi(s) || document.activeElement === s.target)
        return;
      const a = r.get(o);
      if (!a)
        return;
...
const fc = /* @__PURE__ */ uo(function(e) {
  var t, n, r, s;
  let {
    id: o,
    accessibility: a,
    ...
    children: d,
    sensors: c = sc,
    collisionDetection: u = wl,
    measuring: f,
    modifiers: p,
    ...x
  } = e;
  const v = ho(cc, void 0, lc), [w, S] = v, [N, C] = dl(), [D, b] = B(We.Uninitialized), y = D === We.Initialized, {
    draggable: {
      active: m,
      nodes: _,
      translate: z
    ...
    return m != null ? {
      ...
      data: (te = E?.data) != null ? te : oc,
      rect: R
    } : null;
  }, [m, E]), F = M(null), [Q, ee] = B(null), [K, re] = B(null), j = Et(x, Object.values(x)), se = At("DndDescribedBy", o), Ke = L(() => k.getEnabled(), [k]), V = uc(f), {
    droppableRects: Y,
    ...
    config: V.droppable
  }), de = Vl(_, m), Pt = L(() => K ? Jt(K) : null, [K]), Pe = xs(), ke = Xl(de, V.draggable.measure);
  hc({
  ...
  const $ = An(de, V.draggable.measure, ke), dt = An(de ? de.parentElement : null), Ce = M({
    activatorEvent: null,
    active: null,
    activeNode: de,
    collisionRect: null,
  ...
  }), Xe = k.getNodeFor((t = Ce.current.over) == null ? void 0 : t.id), Ae = rc({
    measure: V.dragOverlay.measure
  }), Ye = (n = Ae.nodeRef.current) != null ? n : de, Ze = y ? (r = Ae.rect) != null ? r : $ : null, on = !!(Ae.nodeRef.current && Ae.rect), an = Jl(on ? null : $), vi = Br(Ye ? ne(Ye) : null), Le = Ql(y ? Xe ?? de : null), Lt = nc(Le), Mt = jr(p, {
    transform: {
      x: z.x - an.x,
      y: z.y - an.y,
      scaleX: 1,
    ...
    windowRect: vi
  }), ln = Pt ? rt(Pt, z) : null, cn = ec(Le), fs = zn(cn), ps = zn(cn, [$]), Je = rt(Mt, fs), Qe = Ze ? El(Ze, Mt) : null, ut = T && Qe ? u({
    active: T,
    collisionRect: Qe,
    droppableRects: Y,
    droppableContainers: Ke,
    pointerCoordinates: ln
  }) : null, dn = Tr(ut, "id"), [Me, un] = B(null), gs = on ? Mt : rt(Mt, ps), ms = Cl(gs, (s = Me?.rect) != null ? s : null, $), bi = M(null), hn = U(
    (te, oe) => {
      let {
        sensor: ae,
        options: Ie
      ...
      if (F.current == null)
        return;
      const ue = _.get(F.current);
      if (!ue)
        return;
      const le = te.nativeEvent, _e = new ae({
        active: F.current,
        activeNode: ue,
        event: le,
        options: Ie,
        ...
        return async function() {
          ...
          if (Ee && ft) {
            ...
            Fe = {
              ...
              delta: ft,
              over: ht
            }, J === X.DragEnd && typeof pt == "function" && await Promise.resolve(pt(Fe)) && (J = X.DragCancel);
          }
          F.current = null, Ht(() => {
            S({
              type: J
            }), b(We.Uninitialized), un(null), ee(null), re(null), bi.current = null;
            const pt = J === X.DragEnd ? "onDragEnd" : "onDragCancel";
            if (Fe) {
              const yi = j.current[pt];
              yi?.(Fe), N({
                type: pt,
                event: Fe
              });
    ...
    const ue = ae.nativeEvent, le = _.get(Ie);
    if (
    ...
    te(ae, oe.options, _e) === !0 && (ue.dndKit = {
      capturedBy: oe.sensor
    }, F.current = Ie, hn(ae, oe));
  }, [_, hn]), fn = ql(c, vs);
  tc(c), be(() => {
    $ && D === We.Initializing && b(We.Initialized);
  }, [$, D]), H(
    () => {
      const {
        onDragMove: te
    ...
    () => {
      ...
      if (!te || F.current == null || !oe || !ue)
        return;
      const {
        onDragOver: le
      } = j.current, _e = Ie.get(dn), et = _e && _e.rect.current ? {
        id: _e.id,
  ...
  }, [T, de, ut, Qe, _, Ye, Ze, Y, k, Me, Le, Je]), $l({
    ...Pe,
    delta: z,
    draggingRect: Qe,
    pointerCoordinates: ln,
  ...
  const bs = L(() => ({
    ...
    measuringScheduled: je,
    windowRect: vi
  }), [T, de, $, K, ut, dt, Ae, _, k, Y, Me, Te, Le, Lt, V, je, vi]), ys = L(() => ({
    activatorEvent: K,
    activators: fn,
    active: T,
    activeNodeRect: $,
  ...
  function xs() {
    const te = Q?.autoScrollEnabled === !1, oe = typeof l == "object" ? l.enabled === !1 : l === !1, ae = y && !te && !oe;
...
}), pc = /* @__PURE__ */ Ne(null), Ln = "button", gc = "Draggable";
function mc(i) {
  let {
    id: e,
    data: t,
  ...
  const s = At(gc), {
    ...
    tabIndex: v = 0
  } = r ?? {}, w = l?.id === e, S = ve(w ? gi : pc), [N, C] = Yt(), [D, b] = Yt(), y = ic(o, e), m = Et(t);
  be(
    () => (u.set(e, {
      id: e,
      key: s,
...
function yc(i) {
  ...
  const s = At(vc), {
    ...
    C && (z && (C.unobserve(z), u.current = !1), _ && C.observe(_));
  }, [C]), [b, y] = Yt(D), m = Et(e);
  return H(() => {
...
function xc(i) {
  ...
  const [n, r] = B(null), [s, o] = B(null), a = Zt(t);
  return !t && !n && a && r(a), be(() => {
    if (!s)
      return;
...
const _c = {
  position: "fixed",
  touchAction: "none"
}, Ec = (i) => hi(i) ? "transform 250ms ease" : void 0, Sc = /* @__PURE__ */ ge((i, e) => {
  let {
    as: t,
    activatorEvent: n,
    adjustScale: r,
  ...
  const u = r ? d : {
    ...
    transformOrigin: r && n ? ml(n, a) : void 0,
...
function Tc(i) {
  ...
  return ui((s, o) => {
    ...
    if (!u)
      return;
    const f = typeof e == "function" ? e : kc(e);
    return Hr(l, r.draggable.measure), f({
      active: {
        id: s,
        data: a.data,
        node: l,
...
const Oc = /* @__PURE__ */ I.memo((i) => {
  ...
  return I.createElement(Cc, null, I.createElement(xc, {
    animation: k
  }, u && m ? I.createElement(Sc, {
    key: m,
    id: u.id,
    ref: E,
    as: a,
...
function Mc(i) {
  ...
  } = Ur(), u = At(qr, t), f = a.rect !== null, p = L(() => n.map((y) => typeof y == "object" && "id" in y ? y.id : y), [n]), x = o != null, v = o ? p.indexOf(o.id) : -1, w = d ? p.indexOf(d.id) : -1, S = M(p), N = !Pc(p, S.current), C = w !== -1 && v === -1 || N, D = Lc(s);
  be(() => {
    N && x && c(p);
  }, [N, p, x, c]), H(() => {
    S.current = p;
...
const Ic = (i) => {
  ...
  duration: 200,
  easing: "ease"
}, Xr = "transform", Bc = /* @__PURE__ */ $e.Transition.toString({
  property: Xr,
  duration: 0,
  easing: "linear"
}), Wc = {
...
function Gc(i) {
  ...
  const [s, o] = B(null), a = M(t);
  return be(() => {
    if (!e && t !== a.current && n.current) {
      const l = r.current;
      if (l) {
        const d = ct(n.current, {
          ignoreTransform: !0
        }), c = {
          x: l.left - d.left,
          y: l.top - d.top,
...
function $c(i) {
  ...
  const {
    ...
    useDragOverlay: S,
    strategy: N
  } = ve(Kr), C = jc(n, p), D = c.indexOf(o), b = L(() => ({
    sortable: {
      containerId: u,
      index: D,
      items: c
    ...
    ...r
  }), [u, r, D, c]), y = L(() => c.slice(c.indexOf(o)), [c, o]), {
    rect: m,
    node: _,
    isOver: z,
    setNodeRef: k
  ...
  }), Ke = el(k, Q), V = !!E, Y = V && !x && Bt(f) && Bt(w), Te = !S && K, je = Te && Y ? se : null, Pt = Y ? je ?? (a ?? N)({
    rects: v,
    activeNodeRect: T,
    activeIndex: f,
    overIndex: w,
  ...
  return H(() => {
    V && $.current.newIndex !== Pe && ($.current.newIndex = Pe), u !== $.current.containerId && ($.current.containerId = u), c !== $.current.items && ($.current.items = c);
  }, [V, Pe, u, c]), H(() => {
    if (ke === $.current.activeId)
      return;
    if (ke != null && $.current.activeId == null) {
      $.current.activeId = ke;
      return;
    }
    const Ye = setTimeout(() => {
...
const Uc = [W.Down, W.Right, W.Up, W.Left], Vc = (i, e) => {
  let {
    context: {
      active: t,
      collisionRect: n,
  ...
  if (Uc.includes(i.code)) {
    ...
    if (c === o?.id && d.length > 1 && (c = d[1].id), c != null) {
      ...
      if (x && p && u && f) {
        const w = fi(x).some((y, m) => a[m] !== y), S = Yr(u, f), N = qc(u, f), C = w || !S ? {
          x: 0,
          y: 0
        } : {
        ...
        return C.x && C.y ? D : St(D, C);
      }
    }
  }
};
function Yr(i, e) {
  return !ti(i) || !ti(e) ? !1 : i.data.current.sortable.containerId === e.data.current.sortable.containerId;
}
function qc(i, e) {
  return !ti(i) || !ti(e) || !Yr(i, e) ? !1 : i.data.current.sortable.index < e.data.current.sortable.index;
}
const In = ({ id: i, children: e }) => {
  const { attributes: t, listeners: n, setNodeRef: r, transform: s, transition: o } = $c({
    id: i
  }), a = {
  ...
  const [o, a] = B(null), l = pl(En(Zi), En(Xi, {
    coordinateGetter: Vc
  })), d = (u) => {
    a(u.active.id);
  }, c = (u) => {
...
const Kc = ge(function({ children: e, aside: t, header: n, variant: r = "main-aside" }, s) {
  ...
  Page: pe("Page", Kc),
  Block: pe("Block", ci),
  BlockContent: pe("BlockContent", Za),
  Group: pe("Group", Ui),
  GroupGrid: pe("GroupGrid", li),
  GroupMasonry: pe("GroupMasonry", en)
}, Iu = xe({
  name: "StandardLayout",
  type: "layout"
}, mr), Hu = xe({
...
function Zc(i, e, t) {
  return e && Yc(i.prototype, e), Object.defineProperty(i, "prototype", { writable: !1 }), i;
}
function Jc(i, e, t) {
  return e = ii(e), Qc(i, Zr() ? Reflect.construct(e, t || [], ii(i).constructor) : e.apply(i, t));
}
function Qc(i, e) {
...
var mi = /* @__PURE__ */ (function(i) {
  function e() {
    return Xc(this, e), Jc(this, e, arguments);
  }
  return td(e, i), Zc(e, [{
    key: "render",
    value: function() {
...
function od(i) {
  var e = i.option, t = i.isActive, n = rd(i, nd);
  return typeof e == "string" ? /* @__PURE__ */ I.createElement(mn, xt({
    option: /* @__PURE__ */ I.createElement(vo, xt({
      type: e
    }, n)),
    isActive: t,
    shapeType: "symbols"
  }, n)) : /* @__PURE__ */ I.createElement(mn, xt({
    option: e,
    isActive: t,
    shapeType: "symbols"
  }, n));
...
function he(i) {
  for (var e = 1; e < arguments.length; e++) {
    ...
    e % 2 ? Hn(Object(t), !0).forEach(function(n) {
      Ge(i, n, t[n]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(i, Object.getOwnPropertyDescriptors(t)) : Hn(Object(t)).forEach(function(n) {
...
function ld(i, e, t) {
  return e && Fn(i.prototype, e), t && Fn(i, t), Object.defineProperty(i, "prototype", { writable: !1 }), i;
}
function cd(i, e, t) {
  return e = ni(e), dd(i, es() ? Reflect.construct(e, t || [], ni(i).constructor) : e.apply(i, t));
}
function dd(i, e) {
...
function hd(i, e) {
  if (typeof e != "function" && e !== null)
    throw new TypeError("Super expression must either be null or a function");
  i.prototype = Object.create(e && e.prototype, { constructor: { value: i, writable: !0, configurable: !0 } }), Object.defineProperty(i, "prototype", { writable: !1 }), e && Pi(i, e);
}
function Pi(i, e) {
  return Pi = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(n, r) {
    return n.__proto__ = r, n;
  }, Pi(i, e);
}
function Ge(i, e, t) {
...
var zt = /* @__PURE__ */ (function(i) {
  function e() {
    ...
    for (var n = arguments.length, r = new Array(n), s = 0; s < n; s++)
      r[s] = arguments[s];
    return t = cd(this, e, [].concat(r)), Ge(t, "state", {
  ...
  return hd(e, i), ld(e, [{
    ...
    value: function(n) {
      ...
      return n.map(function(c, u) {
        var f = l === u, p = f ? a : o, x = he(he({}, d), c);
        return /* @__PURE__ */ I.createElement(gt, wt({
          className: "recharts-scatter-symbol",
          key: "symbol-".concat(c?.cx, "-").concat(c?.cy, "-").concat(c?.size, "-").concat(u)
        }, bo(r.props, c, u), {
          role: "img"
        }), /* @__PURE__ */ I.createElement(od, wt({
          option: p,
          isActive: f,
          key: "symbol-".concat(u)
        }, x)));
    ...
    value: function() {
      ...
      return /* @__PURE__ */ I.createElement(yo, {
        begin: a,
        duration: l,
        isActive: o,
        easing: d,
        ...
        return /* @__PURE__ */ I.createElement(gt, null, n.renderSymbolsStatically(x));
      });
    }
  }, {
    key: "renderSymbols",
    value: function() {
      ...
      return s && r && r.length && (!o || !rr(o, r)) ? this.renderSymbolsWithAnimation() : this.renderSymbolsStatically(r);
    }
  }, {
    key: "renderErrorBar",
    value: function() {
    ...
    value: function() {
      ...
      return /* @__PURE__ */ I.isValidElement(s) ? u = /* @__PURE__ */ I.cloneElement(s, N) : Co(s) ? u = s(N) : u = /* @__PURE__ */ I.createElement(_o, wt({}, N, {
        type: a
    ...
    value: function() {
      ...
      if (r || !s || !s.length)
        return null;
      var w = this.state.isAnimationFinished, S = Rs("recharts-scatter", a), N = l && l.allowDataOverflow, C = d && d.allowDataOverflow, D = N || C, b = tt(x) ? this.id : x;
      return /* @__PURE__ */ I.createElement(gt, {
        className: S,
        ...
        width: N ? f : f * 2,
        height: C ? p : p * 2
      }))) : null, o && this.renderLine(), this.renderErrorBar(), /* @__PURE__ */ I.createElement(gt, {
...
Ge(zt, "getComposedData", function(i) {
  var e = i.xAxis, t = i.yAxis, n = i.zAxis, r = i.item, s = i.displayedData, o = i.xAxisTicks, a = i.yAxisTicks, l = i.offset, d = r.props.tooltipType, c = or(r.props.children, Do), u = tt(e.dataKey) ? r.props.dataKey : e.dataKey, f = tt(t.dataKey) ? r.props.dataKey : t.dataKey, p = n && n.dataKey, x = n ? n.range : mi.defaultProps.range, v = x && x[0], w = e.scale.bandwidth ? e.scale.bandwidth() : 0, S = t.scale.bandwidth ? t.scale.bandwidth() : 0, N = s.map(function(C, D) {
    var b = Wt(C, u), y = Wt(C, f), m = !tt(p) && Wt(C, p) || "-", _ = [{
...
const gd = (i) => {
...
}, md = ({ dataConfig: i, data: e, xAxis: t, yAxis: n = {
  hide: !0
}, label: r = !1, hideTooltip: s = !1, hideGrid: o = !1, aspect: a, legend: l, showValueUnderLabel: d = !1, bar: c, line: u, scatter: f, onClick: p }, x) => {
  const v = ko(e), w = c?.categories ? Array.isArray(c.categories) ? c.categories : [c.categories] : [], S = u?.categories ? Array.isArray(u.categories) ? u.categories : [u.categories] : [], N = f?.categories ? Array.isArray(f.categories) ? f.categories : [f.categories] : [], C = [...w, ...S, ...N], D = Math.max(...v.flatMap((m) => C.map((_) => Ao(n?.tickFormatter ? n.tickFormatter(`${m[_]}`) : `${m[_]}`)))), b = [c, u, f].filter((m) => m?.axisPosition === "left"), y = [c, u, f].filter((m) => m?.axisPosition === "right");
  return h(Oo, {
    config: i,
    ref: x,
    aspect: a,
    children: A(pd, {
      ...
      children: [!s && h(zo, {
        ...
        hide: t?.hide,
        tick: d ? (m) => {
          const { x: _, y: z, payload: k } = m, E = e.find((F) => F.label === k.value)?.values || "", R = Object.keys(E).length === 1 ? Object.values(E)?.[0] : void 0, T = R !== void 0 && n.tickFormatter ? n.tickFormatter(`${R}`) : R.toLocaleString();
          return A("g", {
            transform: `translate(${_},${z})`,
            children: [h("text", {
              x: 0,
              y: 0,
              dy: 12,
        ...
        isAnimationActive: !1,
        dataKey: String(m),
        fill: i[m].color ? mt(i[m].color) : wi(_),
        radius: 4,
        maxBarSize: 32,
        children: r && h(ar, {
          position: "top",
      ...
      }, `bar-${String(m)}`)), S.map((m, _) => h(lr, {
        type: u?.lineType ?? "natural",
        dataKey: String(m),
        stroke: i[m].color ? mt(i[m].color) : wi(w.length + _),
        strokeWidth: 2,
        dot: u?.dot ?? !1,
        isAnimationActive: !1,
        yAxisId: u?.axisPosition === "right" ? "right" : void 0
      }, `line-${String(m)}`)), N.map((m, _) => h(zt, {
        dataKey: String(m),
        fill: i[m].color ? mt(i[m].color) : wi(w.length + S.length + _),
        r: 4,
        isAnimationActive: !1,
        yAxisId: f?.axisPosition === "right" ? "right" : void 0,
        shape: gd(String(m))
      }, `scatter-${String(m)}`)), l && h(Fo, {
        content: h(Bo, {
          nameKey: "label"
        }),
        align: "center",
...
}, vd = ur(md), bd = ({ value: i, max: e = 100, label: t, color: n }, r) => {
  const s = n ? mt(n) : mt("categorical-1"), o = i / e * 100;
  return A("div", {
  ...
  }), r = xd(e.trend), s = t(e.comparison), o = Xo(n.numericValue, n.formatterOptions), a = yn(s.numericValue), l = yn(n.numericValue), d = L(() => {
    if (!(!a || !r.show) && !(!a || !l))
      return (l - a) / a * 100;
  }, [l, a, r.show]);
  return A("div", {
...
const Cd = Vn(is, wd), Ku = pe("F0BigNumber", Cd), Xu = Ns.filter(
  (i) => i !== "ai"
), Yu = qn, Zu = ["default", "outline", "neutral"], Ju = qn, Qu = ["sm", "md", "lg"], eh = ["compact", "expanded"], th = Ts, ih = [
  "viridian",
  "malibu",
  "yellow",
  "purple",
...
const nh = pe("F0ChipList", ns), rh = As, _d = Ve({
...
}), sh = ({ title: i, description: e, action: t, link: n, icon: r, variant: s = "neutral" }) => {
  const o = M(null);
  return h("div", {
    ref: o,
    className: "@container",
...
function Dd({ filters: i, value: e, onChange: t, height: n, width: r = 600, className: s, showApplyButton: o = !0, applyButtonLabel: a }) {
  const l = Hi(), [d, c] = B(null), [u, f] = B(e);
  H(() => {
    f(e);
  }, [e]), H(() => {
    if (!d && i) {
  ...
  const p = (w, S) => {
    ...
    t(u);
  }, v = L(() => n || Object.entries(i).reduce((S, [N, C]) => {
    const D = pn(C.type);
    return Math.max(S, D?.formHeight || Sd);
  }, 0), [i, n]);
...
Dd.displayName = "F0FilterPickerContent";
const tn = "gap-4", Rd = "mt-6", qe = "md", rs = Ne(null);
function ss() {
  const i = ve(rs);
  if (!i)
...
function we(i) {
  let e = i;
  for (; q(e, "ZodOptional") || q(e, "ZodNullable") || q(e, "ZodDefault"); )
    e = e._def.innerType;
  return e;
}
function Nd(i, e) {
  ...
  if ("options" in e && e.options || "source" in e && e.source)
    return "select";
  const t = we(i);
  return q(t, "ZodString") ? "rows" in e && e.rows ? "textarea" : "text" : q(t, "ZodNumber") ? "number" : q(t, "ZodBoolean") ? "switch" : q(t, "ZodDate") ? "date" : q(t, "ZodEnum") || q(t, "ZodArray") && ("options" in e && e.options || "source" in e && e.source) ? "select" : q(t, "ZodObject") && "render" in e && e.render ? "custom" : "text";
}
function nn(i) {
  return q(i, "ZodOptional") || q(i, "ZodNullable") || q(i, "ZodDefault") && nn(i._def.innerType);
}
function Td(i) {
  const e = we(i);
  return q(e, "ZodString") ? (e._def.checks || []).some(
...
function Ad(i) {
  const e = we(i);
  return q(e, "ZodLiteral") && e._def.value === !0;
}
function Od({ field: i, formField: e }) {
  const t = i.validation && Ad(i.validation);
  return h(Ms, {
    title: i.label,
    disabled: i.disabled,
    required: t,
...
function zd({ field: i, formField: e, error: t, isValidating: n }) {
  const r = {
    id: i.id,
    label: i.label,
...
function Md({ field: i, formField: e, error: t, loading: n }) {
  const r = L(() => Pd(e.value, i.granularities), [e.value, i.granularities]), s = (o) => {
    e.onChange(Ld(o));
  };
  return h(hr, {
    label: i.label,
...
function Fd({ field: i, formField: e, error: t, loading: n }) {
  const r = L(() => Id(e.value), [e.value]), s = (a) => {
    e.onChange(Hd(a));
...
function jd(i) {
  const { field: e } = i;
  return "source" in e && e.source !== void 0 && e.mapOptions !== void 0 ? h($d, {
    ...i,
    field: e
  }) : "options" in e && e.options !== void 0 ? h(Gd, {
    ...i,
    field: e
  }) : null;
}
...
function Vd({ field: i, formField: e }) {
  const t = i.validation && Ud(i.validation);
  return h(Is, {
    title: i.label,
    disabled: i.disabled,
    required: t,
...
function Xd({ field: i, formField: e, error: t, loading: n }) {
  const r = i.inputType ?? "text", s = i.placeholder ?? qd[r] ?? void 0, o = Kd[r];
  return h(Hs, {
    label: i.label,
    type: r,
    placeholder: s,
...
function Yd({ field: i, formField: e, error: t, loading: n }) {
  return h(ea, {
    label: i.label,
    placeholder: i.placeholder,
    disabled: i.disabled,
...
function Zd({ field: i, formField: e, fieldState: t, isSubmitting: n }) {
...
function sn({ field: i, sectionId: e }) {
  ...
  if (i.renderIf && !rn(i.renderIf, n))
    return null;
  const o = i.type !== "checkbox" && i.type !== "custom", a = i.validation && kd(i.validation), l = ri(s, e, i.id);
  return h(ta, {
    control: t.control,
    name: i.id,
...
function cs({ fields: i }) {
  const e = Bi(), { watch: t, setValue: n } = e, { isSubmitting: r } = e.formState, s = t(), o = L(() => i.filter((c) => !c.renderIf || rn(c.renderIf, s)), [i, s]), a = L(() => o.map((c) => ({
    value: c.id,
    title: c.label,
    description: c.helpText,
    disabled: c.disabled || r,
    required: !!(c.validation && Jd(c.validation))
  })), [o, r]), l = L(() => o.filter((c) => s[c.id]).map((c) => c.id), [o, s]);
...
function iu({
  ...
  const t = Object.keys(e).filter((f) => f !== "root"), n = t.length > 0, r = t.length, [s, o] = B(0), a = M([]);
  H(() => {
    const f = t, p = a.current, x = f.find(
      (v) => !p.includes(v)
    );
    if (x) {
      const v = ri(i, void 0, x);
      Bn(v);
      const w = f.indexOf(x);
      w !== -1 && o(w);
    }
...
function ou(i) {
  const e = we(i);
  return q(e, "ZodString") ? (e._def.checks || []).some((n) => n.kind === "email") : !1;
}
function au(i) {
  const e = we(i);
  return q(e, "ZodString") ? (e._def.checks || []).some((n) => n.kind === "url") : !1;
}
function Wn(i) {
  return ou(i) ? "email" : au(i) ? "url" : "text";
}
function Gn(i, e, t, n) {
  const r = {
    id: i,
  ...
  switch (n) {
    case "text": {
      const o = "inputType" in t && t.inputType ? t.inputType : Wn(e);
      return {
        ...r,
        type: "text",
        inputType: o,
    ...
    case "date": {
      const { minDate: o, maxDate: a } = ru(e);
      return {
        ...r,
        type: "date",
  ...
  for (let n = 0; n < i.length; n++) {
    ...
    if (s) {
      ...
      const a = {
        type: "row",
        fields: o.map(
          (l) => Gn(l.id, l.schema, l.config, l.fieldType)
        )
      };
      e.push(a);
    } else {
...
function hu(i) {
  const e = Hi(), { forms: t } = e, { name: n, schema: r, sections: s, defaultValues: o, onSubmit: a, submitConfig: l, className: d, errorTriggerMode: c = "on-blur" } = i, u = l?.type === "action-bar", f = l?.label ?? "Submit", p = l?.icon === null ? void 0 : l?.icon ?? Ws, x = !u, v = l?.type === "action-bar" && l?.discardable, w = u ? l?.discardConfig : void 0, S = w?.label ?? t.actionBar.discard, N = w?.icon === null ? void 0 : w?.icon ?? Gs, C = u ? l?.actionBarLabel ?? t.actionBar.unsavedChanges : t.actionBar.unsavedChanges, D = u && !!l?.centerActionBarInFrameContent, b = lu(r, s), y = L(() => cu(e), [e]), m = uu[c], _ = la({
    resolver: ca(r, {
      errorMap: y
    }),
    mode: m,
    defaultValues: o
  }), z = _.formState.errors.root, { isDirty: k, isSubmitting: E, errors: R } = _.formState, { hasErrors: T, errorCount: F, goToPreviousError: Q, goToNextError: ee, resetErrorNavigation: K } = iu({
    formName: n,
    errors: R
  }), re = async (V) => {
    const Y = await a(V);
    Y.success || (Y.errors && Object.entries(Y.errors).forEach(([Te, je]) => {
      _.setError(Te, {
        message: je
      });
    }), Y.rootMessage && _.setError("root", {
      message: Y.rootMessage
    }));
  }, j = () => {
    _.reset(), K();
  }, se = du(b), Ke = L(() => ({
  ...
  return h(rs.Provider, {
    ...
    children: A(da, {
      ..._,
      children: [A("form", {
        onSubmit: _.handleSubmit(re),
        className: G(`flex flex-col ${tn} max-w-[600px]`, d),
        children: [se.map((V, Y) => {
          switch (V.type) {
            case "switchGroup":
              return h(cs, {
        ...
        leftContent: T ? A("div", {
          ...
          children: [A("div", {
            ...
            children: [h(Fi, {
              ...
              children: F === 1 ? t.actionBar.issues.one.replace("{{count}}", String(F)) : t.actionBar.issues.other.replace("{{count}}", String(F))
            })]
          }), F > 1 && A("div", {
            className: "flex items-center gap-2",
            children: [h(Re, {
...
const ch = pe("F0Form", hu), fu = ge((i, e) => h(ji, {
  ref: e,
  variant: "heading",
  ...i
}));
fu.displayName = "F0Heading";
const dh = pe(
  "F0GridStack",
  $i
), Ri = 16, pu = Ve({
...
function mu({ items: i, activeItem: e, className: t, align: n = "left", variant: r = "dark" }) {
  const s = L(() => gu(us(i), e), [i, e]);
  return h("div", {
...
function xu({ title: i, items: e, className: t, activeItem: n, collapsible: r = !1, showChildrenCounter: s = !1, barsAlign: o = "left", size: a = "md", variant: l = "light" }) {
  ...
  return A(Vs, {
    ...
    children: [h(qs, {
      asChild: !0,
      children: h("button", {
        className: G(Yn(), "flex cursor-pointer items-center rounded-md px-1.5 py-1", t),
        "aria-label": i ?? "Menu",
        children: h(mu, {
          items: e,
          activeItem: n,
...
}), hs = ge(({ title: i, image: e, benefits: t, actions: n, withShadow: r = !0, module: s, moduleName: o, tag: a, promoTag: l }, d) => A("div", {
  ref: d,
...
function _u({ isOpen: i, onClose: e, title: t, children: n, module: r, portalContainer: s }) {
  const [o, a] = B(i);
  return H(() => {
    a(i);
  }, [i]), h(Zs, {
...
function hh({ isOpen: i, onClose: e, title: t, image: n, benefits: r, errorMessage: s, successMessage: o, loadingState: a, nextSteps: l, closeLabel: d, primaryAction: c, modalTitle: u, modalModule: f, secondaryAction: p, portalContainer: x, tag: v, promoTag: w, showResponseDialog: S = !0 }) {
  const [N, C] = B(i), [D, b] = B(null), [y, m] = B(!1), _ = async () => {
    if (c?.onClick) {
      m(!0);
      try {
...
function Eu({ mediaUrl: i, title: e, description: t, onClose: n, dismissible: r, width: s, trackVisibility: o, actions: a, showConfirmation: l = !0 }) {
  const [d, c] = B(!1), u = () => {
    c(!0), n && n();
  };
  H(() => {
...
const Su = ge(function({ primaryAction: e, secondaryAction: t, ...n }, r) {
...
Su.displayName = "UpsellingBanner";
function fh({ isOpen: i, setIsOpen: e, label: t, variant: n = "promote", size: r = "md", showIcon: s = !0, side: o = "right", align: a = "center", icon: l = eo, mediaUrl: d, title: c, description: u, width: f = "300px", trackVisibility: p, actions: x, onClick: v, hideLabel: w = !1 }) {
  const [S, N] = B(!1), [C, D] = B(null), [b, y] = B(null), m = (R) => {
    e(R), v && v();
  }, _ = async (R) => {
    if (R.type === "upsell") {
      y(R);
  ...
  return A(Nt, {
    ...
    }), b?.type === "upsell" && b.showConfirmation && C && h(fr, {
      open: !0,
      onClose: z,
      success: C === "success",
...
const Du = Ne(null), Ru = ({ children: i, fullScreen: e = !0 }) => {
  const t = M(null), [n, r] = B(t.current);
  return ao(() => {
    r(t.current);
  }, []), h(Du.Provider, {
    value: {
  ...
  reducedMotion: "user",
  children: i
}), ph = ({ children: i, layout: e, link: t, privacyModeInitiallyEnabled: n, image: r, i18n: s, l10n: o, isDev: a = !1, dataCollectionStorageHandler: l, showExperimentalWarnings: d = !1 }) => h(Nu, {
  children: h(to, {
    isDev: a,
...
export {
  bh as A,
  ip as AiChatTranslationsProvider,
  Bu as AreaChart,
  yh as Await,
  Wu as BarChart,
  xh as Blockquote,
  ...
  Eh as F0ActionItem,
  Sh as F0AiChat,
  Dh as F0AiChatProvider,
  Rh as F0AiChatTextArea,
  Nh as F0AiCollapsibleMessage,
  Th as F0AiFullscreenChat,
  sh as F0Alert,
  np as F0AuraVoiceAnimation,
  kh as F0Avatar,
  Zo as F0AvatarAlert,
  Ah as F0AvatarCompany,
  Pf as F0AvatarDate,
  Oh as F0AvatarEmoji,
  zh as F0AvatarFile,
  Os as F0AvatarIcon,
  ...
  Ph as F0AvatarPerson,
  Lh as F0AvatarTeam,
  Ku as F0BigNumber,
  Re as F0Button,
  Mh as F0ButtonDropdown,
  Ih as F0ButtonToggle,
  Mf as F0Card,
  Ms as F0Checkbox,
  nh as F0ChipList,
  hr as F0DatePicker,
  ...
  Bh as F0DialogProvider,
  Wh as F0EventCatcherProvider,
  Dd as F0FilterPickerContent,
  ch as F0Form,
  dh as F0GridStack,
  ...
  Cr as F0Text,
  Uh as F0Thinking,
  Vh as FullscreenChatContext,
  qh as GROUP_ID_SYMBOL,
  Kh as H1,
  Xh as H2,
  Yh as H3,
  Fu as HomeLayout,
  ...
  $u as LineChart,
  ef as Ol,
  tf as OneFilterPicker,
  nf as P,
  ju as PieChart,
  rf as Pre,
  ba as PrivacyModeProvider,
  hs as ProductBlankslate,
  $f as ProductCard,
  hh as ProductModal,
  Eu as ProductWidget,
  Vu as ProgressBarChart,
  Iu as StandardLayout,
  sf as Strong,
  of as Table,
  jf as Tag,
  Uf as TagCounter,
  af as Td,
  lf as Th,
  Hu as TwoColumnLayout,
  cf as Ul,
  fr as UpsellRequestResponseDialog,
  Su as UpsellingBanner,
  pr as UpsellingButton,
  fh as UpsellingPopover,
  Uu as VerticalBarChart,
  sp as actionItemStatuses,
  op as aiTranslations,
  Pu as avatarVariants,
  df as buildTranslations,
  Ju as buttonDropdownSizes,
  Zu as buttonDropdownVariants,
  Yu as buttonSizes,
  Qu as buttonToggleSizes,
  eh as buttonToggleVariants,
  Xu as buttonVariants,
  Vf as cardImageFits,
  qf as cardImageSizes,
  Kf as createAtlaskitDriver,
  uf as createDataSourceDefinition,
  Fa as createPageLayoutBlock,
  Ba as createPageLayoutBlockGroup,
  gh as dataCollectionLocalStorageHandler,
  rh as datepickerSizes,
  dp as defaultTranslations,
  hf as downloadTableAsExcel,
  rn as evaluateRenderIf,
  pe as experimental,
  oh as f0FormField,
  ff as f0MarkdownRenderers,
  ri as generateAnchorId,
  pf as getAnimationVariants,
  gf as getDataSourcePaginationType,
  mf as getEmojiLabel,
  as as getF0Config,
  lh as getSchemaDefinition,
  ah as hasF0Config,
  Nd as inferFieldType,
  vf as isInfiniteScrollPagination,
  bf as isPageBasedPagination,
  q as isZodType,
  th as linkVariants,
  yf as modules,
  ap as oneIconSizes,
  Xf as predefinedPresets,
  Yf as selectSizes,
  ih as tagDotColors,
  ...
  wf as useData,
  Cf as useDataSource,
  _f as useDefaultCopilotActions,
  Zf as useDndEvents,
  Jf as useDraggable,
  Qf as useDroppableList,
  Ef as useEmojiConfetti,
  Sf as useF0Dialog,
  Df as useGroups,
  Rf as useMessageSourcesAction,
  Nf as useOrchestratorThinkingAction,
  ep as usePrivacyMode,
  Tf as useReducedMotion,
  lu as useSchemaDefinition,
  kf as useSelectable,
  Af as useXRay
};
