import { a6 as G, a7 as Ge, aa as Dn, ab as Ri, ac as Ni, ad as Yr, ae as qr, af as Sn, ag as we, u as Rn, ah as Nn, ai as Jr, aj as Zr, ak as Qr, al as es, am as fe, an as ve, ao as ts, ap as is, aq as An, ar as ns, as as Lt, at as On, au as kn, av as Tn, aw as zn, ax as Pn, ay as Mn, az as rs, aA as ss, aB as os, aC as as, aD as ls, a8 as We, aE as Ji, aF as cs, aG as ds, aH as us, aI as hs, aJ as Ln, aK as fs, aL as gs, aM as ps, aN as ms, aO as vs, aP as In, aQ as ys, aR as bs, aS as xs, aT as ws, aU as Cs, aV as _s, I as Es, aW as Ds, aX as Ss, aY as Rs, aZ as Ns } from "./F0AiChat-dI6LOteE.js";
import { A as zd, be as Pd, B as Md, C as Ld, E as Id, bt as Hd, h as Fd, F as Bd, a as Wd, x as Gd, i as $d, b as jd, a_ as Ud, a$ as Vd, b0 as Kd, b1 as Xd, b3 as Yd, b4 as qd, b5 as Jd, b6 as Zd, b7 as Qd, b8 as eu, b9 as tu, ba as iu, bp as nu, s as ru, t as su, v as ou, bc as au, w as lu, c as cu, bf as du, n as uu, o as hu, p as fu, H as gu, k as pu, L as mu, O as vu, bd as yu, q as bu, P as xu, S as wu, T as Cu, l as _u, m as Eu, U as Du, bq as Su, bk as Ru, r as Nu, j as Au, bn as Ou, bj as ku, bu as Tu, bi as zu, bh as Pu, b2 as Mu, d as Lu, bg as Iu, bl as Hu, e as Fu, bv as Bu, bb as Wu, bm as Gu, g as $u, f as ju, bs as Uu, bo as Vu, br as Ku } from "./F0AiChat-dI6LOteE.js";
import { jsx as f, jsxs as T, Fragment as Jt } from "react/jsx-runtime";
import L, { forwardRef as oe, useRef as M, useImperativeHandle as As, Children as It, createContext as Ae, useContext as _e, useState as F, useMemo as H, useEffect as I, useCallback as U, useLayoutEffect as bi, createElement as Zi, isValidElement as Hn, Fragment as Os, memo as ks, useReducer as Ts, cloneElement as zs, PureComponent as Ps } from "react";
import { createPortal as Fn, unstable_batchedUpdates as Ot } from "react-dom";
import { L as Bn, C as Ms, i as Wn, D as Ls, S as Qi, a as Is, f as ui, b as ct, c as Hs, A as Fs, d as kt, e as Gn, E as Bs, g as Pt, h as Ws, j as Gs, k as $s, l as Ye, m as $n, u as js, G as Us, n as Vs, o as en, p as Ks, q as jn, r as Xs, B as Un, X as Vn, Y as xi, s as Ys, t as Kn, v as qs, w as Js, x as Zs, y as Qs, z as eo, F as to, H as io, I as no, J as tn, K as ro, M as dt, N as hi, O as so, P as oo, Q as ao, R as lo, T as co, U as uo, V as ho, W as fo, Z as go, _ as po, $ as mo, a0 as nn, a1 as vo, a2 as yo, a3 as bo, a4 as xo, a5 as Xn, a6 as rn, a7 as Yn, a8 as wo, a9 as Co, aa as _o, ab as Eo } from "./DataCollectionStorageProvider-BuovXErp.js";
import { au as Yu, ac as qu, ad as Ju, ag as Zu, ah as Qu, al as eh, am as th, an as ih, ap as nh, aq as rh, ar as sh, as as oh, ak as ah, ao as lh, ae as ch, af as dh, at as uh, ai as hh, aj as fh, av as gh, aw as ph, ax as mh, ay as vh } from "./DataCollectionStorageProvider-BuovXErp.js";
import { A as bh, F as xh, c as wh, b as Ch, a as _h, o as Eh, u as Dh } from "./F0HILActionConfirmation-BhdxxqIg.js";
...
const ki = ({ options: n, widgets: e, onChange: t, className: i }) => {
...
function ri(n, e) {
  ...
  function i(r) {
    if (e != null && t.length >= e || !r)
      return t;
    if (Mi(r) && r.scrollingElement != null && !t.includes(r.scrollingElement))
...
function La(n, e, t, i, r) {
  ...
  return !d && s <= e.top + b.height ? (g.y = X.Backward, C.y = i * Math.abs((e.top + b.height - s) / b.height)) : !l && c >= e.bottom - b.height && (g.y = X.Forward, C.y = i * Math.abs((e.bottom - b.height - c) / b.height)), !h && a >= e.right - b.width ? (g.x = X.Forward, C.x = i * Math.abs((e.right - b.width - a) / b.width)) : !u && o <= e.left + b.width && (g.x = X.Backward, C.x = i * Math.abs((e.left + b.width - o) / b.width)), {
    direction: g,
    speed: C
  };
}
...
class Hi {
  ...
  attach() {
    ...
    if (this.listeners.add(e.move.name, this.handleMove, {
      passive: !1
    }), this.listeners.add(e.end.name, this.handleEnd), e.cancel && this.listeners.add(e.cancel.name, this.handleCancel), this.windowListeners.add(de.Resize, this.handleCancel), this.windowListeners.add(de.DragStart, un), this.windowListeners.add(de.VisibilityChange, this.handleCancel), this.windowListeners.add(de.ContextMenu, un), this.documentListeners.add(de.Keydown, this.handleKeydown), t) {
      if (i != null && i({
...
Va.activators = [{
  ...
  handler: (n, e) => {
    ...
    return t.button === Ci.RightClick ? !1 : (i?.({
      event: t
    }), !0);
  }
}];
...
const yl = /* @__PURE__ */ ks(function(e) {
  var t, i, r, s;
  let {
    id: o,
    accessibility: a,
  ...
  const b = Ts(gl, void 0, fl), [x, D] = b, [N, w] = pa(), [S, v] = F(Ie.Uninitialized), y = S === Ie.Initialized, {
    draggable: {
      active: m,
      nodes: E,
      translate: z
...
function Dl(n) {
  ...
  }, [e, i, s]), L.createElement(L.Fragment, null, t, i ? zs(i, {
    ref: o
  }) : null);
}
const Sl = {
...
function uc(n) {
  ...
  return typeof e == "string" ? /* @__PURE__ */ L.createElement(Qi, gt({
    option: /* @__PURE__ */ L.createElement(Is, gt({
      type: e
    }, i)),
    isActive: t,
    shapeType: "symbols"
...
var Dt = /* @__PURE__ */ (function(n) {
  ...
  return vc(e, n), fc(e, [{
    ...
    value: function() {
      ...
      return /* @__PURE__ */ L.createElement(Fs, {
        begin: a,
        duration: c,
        isActive: o,
        easing: d,
    ...
    value: function() {
      ...
      if (i && !this.state.isAnimationFinished)
        return null;
      var r = this.props, s = r.points, o = r.xAxis, a = r.yAxis, c = r.children, d = Gn(c, Bs);
    ...
    key: "renderLine",
    value: function() {
      var i = this.props, r = i.points, s = i.line, o = i.lineType, a = i.lineJointType, c = ui(this.props, !1), d = ui(s, !1), l, u;
      if (o === "joint")
        l = r.map(function(w) {
          return {
            x: w.cx,
        ...
        var h = Ws(r), g = h.xmin, C = h.xmax, b = h.a, x = h.b, D = function(S) {
          return b * S + x;
        };
        l = [{
          x: g,
      ...
      return /* @__PURE__ */ L.isValidElement(s) ? u = /* @__PURE__ */ L.cloneElement(s, N) : Gs(s) ? u = s(N) : u = /* @__PURE__ */ L.createElement($s, pt({}, N, {
        type: a
...
const xc = (n) => {
  ...
  const b = qs(e), x = l?.categories ? Array.isArray(l.categories) ? l.categories : [l.categories] : [], D = u?.categories ? Array.isArray(u.categories) ? u.categories : [u.categories] : [], N = h?.categories ? Array.isArray(h.categories) ? h.categories : [h.categories] : [], w = [...x, ...D, ...N], S = Math.max(...b.flatMap((m) => w.map((E) => Js(i?.tickFormatter ? i.tickFormatter(`${m[E]}`) : `${m[E]}`)))), v = [l, u, h].filter((m) => m?.axisPosition === "left"), y = [l, u, h].filter((m) => m?.axisPosition === "right");
  return f(Zs, {
    config: n,
    ref: C,
    aspect: a,
  ...
  const t = po(), i = t(e.value, {
    formatterOptions: {
      decimalPlaces: 2
    }
  }), r = Dc(e.trend), s = t(e.comparison), o = mo(i.numericValue, i.formatterOptions), a = nn(s.numericValue), c = nn(i.numericValue), d = H(() => {
    if (!(!a || !r.show) && !(!a || !c))
      return (c - a) / a * 100;
  }, [c, a, r.show]);
  return T("div", {
...
function Nd({ isOpen: n, setIsOpen: e, label: t, variant: i = "promote", size: r = "md", showIcon: s = !0, side: o = "right", align: a = "center", icon: c = ws, mediaUrl: d, title: l, description: u, width: h = "300px", trackVisibility: g, actions: C, onClick: b, hideLabel: x = !1 }) {
...
export {
  zd as A,
  bh as AiChatTranslationsProvider,
  sd as AreaChart,
  Pd as Await,
  od as BarChart,
  Md as Blockquote,
  ...
  Fd as F0ActionItem,
  Bd as F0AiChat,
  Wd as F0AiChatProvider,
  Gd as F0AiChatTextArea,
  ...
  fd as F0BigNumber,
  We as F0Button,
  Jd as F0ButtonDropdown,
  Zd as F0ButtonToggle,
  Zu as F0Card,
  Qd as F0Checkbox,
  Cd as F0ChipList,
  Qu as F0DatePicker,
  eu as F0Dialog,
  tu as F0DialogContext,
  iu as F0DialogProvider,
  ...
  nr as F0Text,
  lu as F0Thinking,
  cu as FullscreenChatContext,
  du as GROUP_ID_SYMBOL,
  uu as H1,
  hu as H2,
  fu as H3,
  rd as HomeLayout,
  ...
  Rh as defaultTranslations,
  Nu as downloadTableAsExcel,
  fe as experimental,
  Au as f0MarkdownRenderers,
  Ou as getAnimationVariants,
  ku as getDataSourcePaginationType,
  Tu as getEmojiLabel,
  zu as isInfiniteScrollPagination,
  ...
  gh as useDndEvents,
  ph as useDraggable,
  mh as useDroppableList,
  Bu as useEmojiConfetti,
  Wu as useF0Dialog,
  Gu as useGroups,
  $u as useMessageSourcesAction,
  ju as useOrchestratorThinkingAction,
  vh as usePrivacyMode,
  Uu as useReducedMotion,
  Vu as useSelectable,
  Ku as useXRay
};
